...
class ABTest extends AbstractModel implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    protected static $modelTypes = [
        ...
        'stoppedAt' => 'string',
        'name' => 'string',
        'status' => '\Flapjack\FlapjackSearch\Model\Abtesting\Status',
        'variants' => '\Flapjack\FlapjackSearch\Model\Abtesting\Variant[]',
        'configuration' => '\Flapjack\FlapjackSearch\Model\Abtesting\ABTestConfiguration',
    ];
