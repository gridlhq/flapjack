...
<!-- centered badges -->
<p align="center">
  <a href="https://pub.dartlang.org/packages/flapjack_client_insights"><img src="https://img.shields.io/pub/v/flapjack_client_insights.svg" alt="Latest version"></a>
  <a href="https://pub.dev/packages/flapjack_client_insights/publisher"><img src="https://img.shields.io/pub/publisher/flapjack_client_insights.svg" alt="Publisher"></a>
</p>
...
```shell
dart pub add flapjack_client_insights
```

#### For Flutter projects:

```shell
flutter pub add flapjack_client_insights
```
