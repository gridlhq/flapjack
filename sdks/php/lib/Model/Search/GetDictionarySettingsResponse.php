...
class GetDictionarySettingsResponse extends AbstractModel implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    protected static $modelTypes = [
        'disableStandardEntries' => '\Flapjack\FlapjackSearch\Model\Search\StandardEntries',
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if (!isset($this->container['disableStandardEntries']) || null === $this->container['disableStandardEntries']) {
