...
public enum class MetricName(public val value: kotlin.String) {
  ...
  @SerialName(value = "search_count") SearchCount("search_count"),
  @SerialName(value = "tracked_search_count") TrackedSearchCount("tracked_search_count"),
  ...
  @SerialName(value = "converted_search_count") ConvertedSearchCount("converted_search_count"),
