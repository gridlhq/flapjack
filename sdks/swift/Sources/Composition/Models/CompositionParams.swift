...
public struct CompositionParams: Codable, JSONEncodable {
    ...
    /// Assigns a rule context to the run query [Rule contexts](https://www.flapjack.io/doc/guides/managing-results/rules/rules-overview/how-to/customize-search-results-by-platform/#whats-a-context)
