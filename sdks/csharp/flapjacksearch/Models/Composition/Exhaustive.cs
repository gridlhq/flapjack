...
public partial class Exhaustive
{
  ...
  /// <summary>
  /// Whether the facet count is exhaustive (`true`) or approximate (`false`). See the [related discussion](https://support.flapjack.io/hc/articles/4406975248145-Why-are-my-facet-and-hit-counts-not-accurate).
  /// </summary>
  /// <value>Whether the facet count is exhaustive (`true`) or approximate (`false`). See the [related discussion](https://support.flapjack.io/hc/articles/4406975248145-Why-are-my-facet-and-hit-counts-not-accurate).</value>
