...
open class AnalyticsClient {
    ...
    /// data](https://www.flapjack.io/doc/guides/search-analytics/guides/segments).  (optional)
    ...
    open func getAddToCartRateWithHTTPInfo(
        ...
        guard !index.isEmpty else {
            throw FlapjackError.invalidArgument("index", "getAddToCartRate")
        }
    ...
    // receive any [click events](https://www.flapjack.io/doc/guides/sending-events/getting-started) for the queries.
    // The
    ...
    open func getAverageClickPositionWithHTTPInfo(
        ...
        guard !index.isEmpty else {
            throw FlapjackError.invalidArgument("index", "getAverageClickPosition")
        }
    ...
    // events](https://www.flapjack.io/doc/guides/sending-events/getting-started) for the queries.
    // Required API Key ACLs:
    //  - analytics
    //
    // - parameter index: (query) Index name.
    ...
    open func getClickPositionsWithHTTPInfo(
        ...
        guard !index.isEmpty else {
            throw FlapjackError.invalidArgument("index", "getClickPositions")
        }
    ...
    open func getClickThroughRateWithHTTPInfo(
        ...
        guard !index.isEmpty else {
            throw FlapjackError.invalidArgument("index", "getClickThroughRate")
        }
    ...
    open func getConversionRateWithHTTPInfo(
        ...
        guard !index.isEmpty else {
            throw FlapjackError.invalidArgument("index", "getConversionRate")
        }
    ...
    open func getNoClickRateWithHTTPInfo(
        ...
        guard !index.isEmpty else {
            throw FlapjackError.invalidArgument("index", "getNoClickRate")
        }
    ...
    open func getNoResultsRateWithHTTPInfo(
        ...
        guard !index.isEmpty else {
            throw FlapjackError.invalidArgument("index", "getNoResultsRate")
        }
    ...
    open func getPurchaseRateWithHTTPInfo(
        ...
        guard !index.isEmpty else {
            throw FlapjackError.invalidArgument("index", "getPurchaseRate")
        }
    ...
    open func getRevenueWithHTTPInfo(
        ...
        guard !index.isEmpty else {
            throw FlapjackError.invalidArgument("index", "getRevenue")
        }
    ...
    open func getSearchesCountWithHTTPInfo(
        ...
        guard !index.isEmpty else {
            throw FlapjackError.invalidArgument("index", "getSearchesCount")
        }
    ...
    open func getSearchesNoClicksWithHTTPInfo(
        ...
        guard !index.isEmpty else {
            throw FlapjackError.invalidArgument("index", "getSearchesNoClicks")
        }
    ...
    open func getSearchesNoResultsWithHTTPInfo(
        ...
        guard !index.isEmpty else {
            throw FlapjackError.invalidArgument("index", "getSearchesNoResults")
        }
    ...
    open func getStatusWithHTTPInfo(
        ...
        guard !index.isEmpty else {
            throw FlapjackError.invalidArgument("index", "getStatus")
        }
    ...
    open func getTopCountriesWithHTTPInfo(
        ...
        guard !index.isEmpty else {
            throw FlapjackError.invalidArgument("index", "getTopCountries")
        }
    ...
    open func getTopFilterAttributesWithHTTPInfo(
        ...
        guard !index.isEmpty else {
            throw FlapjackError.invalidArgument("index", "getTopFilterAttributes")
        }
    ...
    open func getTopFilterForAttributeWithHTTPInfo(
        ...
        guard !attribute.isEmpty else {
            throw FlapjackError.invalidArgument("attribute", "getTopFilterForAttribute")
        }

        guard !index.isEmpty else {
            throw FlapjackError.invalidArgument("index", "getTopFilterForAttribute")
        }
    ...
    open func getTopFiltersNoResultsWithHTTPInfo(
        ...
        guard !index.isEmpty else {
            throw FlapjackError.invalidArgument("index", "getTopFiltersNoResults")
        }
    ...
    // 
    // - Add-to-cart count - Add-to-cart rate (ATCR) - Purchase count - Purchase rate - Revenue details for each
    // currency
    ...
    open func getTopHitsWithHTTPInfo(
        ...
        guard !index.isEmpty else {
            throw FlapjackError.invalidArgument("index", "getTopHits")
        }
    ...
    // searches are Search API requests with `clickAnalytics` set to `true`.   This differs from the response's `count`,
    // which includes searches where `clickAnalytics` is `false`. - Click count - Click-through rate (CTR) - Conversion
    // count - Conversion rate (CR) - Average click position  If you set the `revenueAnalytics` query parameter to
    // `true`, the response also includes:  - Add-to-cart count - Add-to-cart rate (ATCR) - Purchase count - Purchase
    // rate - Revenue details for each currency  **There's a difference between 0% rates and null rates:**  - **Null**
    // means there were no queries. Algolia didn't receive any events, so rates are null. - **0% rates** mean there were
    // queries but no [click or conversion events](https://www.flapjack.io/doc/guides/sending-events/getting-started)
    // were received.
    // Required API Key ACLs:
    //  - analytics
    //
    ...
    open func getTopSearchesWithHTTPInfo(
        ...
        guard !index.isEmpty else {
            throw FlapjackError.invalidArgument("index", "getTopSearches")
        }
    ...
    open func getUsersCountWithHTTPInfo(
        ...
        guard !index.isEmpty else {
            throw FlapjackError.invalidArgument("index", "getUsersCount")
        }
