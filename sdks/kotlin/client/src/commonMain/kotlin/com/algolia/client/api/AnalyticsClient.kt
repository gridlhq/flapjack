...
import com.flapjackhq.client.model.analytics.*
...
public class AnalyticsClient(
  ...
  override val requester: Requester =
    requesterOf(
      ...
      val url = if (region == null) "analytics.flapjack.io" else "analytics.$region.flapjack.io"
      listOf(Host(url))
    }
   ...
   * [add-to-cart events](https://www.flapjack.io/doc/guides/sending-events/getting-started) were
   * received.
   *
   ...
   *   [Segment your analytics data](https://www.flapjack.io/doc/guides/search-analytics/guides/segments).
   * @param requestOptions additional request configuration.
   */
   ...
   * [click events](https://www.flapjack.io/doc/guides/sending-events/getting-started) for the
   ...
   * [click events](https://www.flapjack.io/doc/guides/sending-events/getting-started) were
   * received.
   *
   * Required API Key ACLs:
   * - analytics
   ...
   * [conversion events](https://www.flapjack.io/doc/guides/sending-events/getting-started) were
   * received.
   *
   * Required API Key ACLs:
   * - analytics
   ...
   * [purchase conversion events](https://www.flapjack.io/doc/guides/sending-events/getting-started)
   * were received.
   *
   * Required API Key ACLs:
   * - analytics
   ...
   * [Retrieve searches without results](https://www.flapjack.io/doc/rest-api/analytics/get-searches-no-results)
   * operation.
   *
   * Required API Key ACLs:
   * - analytics
   ...
   * [click or conversion events](https://www.flapjack.io/doc/guides/sending-events/getting-started)
   * were received.
   *
   * Required API Key ACLs:
   * - analytics
