...
public struct SettingsResponse: Codable, JSONEncodable {
...
extension SettingsResponse: Equatable {
    public static func ==(lhs: SettingsResponse, rhs: SettingsResponse) -> Bool {
...
extension SettingsResponse: Hashable {
