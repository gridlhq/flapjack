...
class Run extends AbstractModel implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    protected static $modelTypes = [
        ...
        'appID' => 'string',
        'taskID' => 'string',
        'status' => '\Flapjack\FlapjackSearch\Model\Ingestion\RunStatus',
        'progress' => '\Flapjack\FlapjackSearch\Model\Ingestion\RunProgress',
        'outcome' => '\Flapjack\FlapjackSearch\Model\Ingestion\RunOutcome',
        'failureThreshold' => 'int',
        'reason' => 'string',
        'reasonCode' => '\Flapjack\FlapjackSearch\Model\Ingestion\RunReasonCode',
        'type' => '\Flapjack\FlapjackSearch\Model\Ingestion\RunType',
        'createdAt' => 'string',
        'startedAt' => 'string',
        'finishedAt' => 'string',
    ];
