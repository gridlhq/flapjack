...
open class RecommendClient {
    ...
    /// model](https://www.flapjack.io/doc/guides/algolia-recommend/overview/#recommend-models).
    ...
    open func batchRecommendRulesWithHTTPInfo(
        ...
        guard !indexName.isEmpty else {
            throw FlapjackError.invalidArgument("indexName", "batchRecommendRules")
        }
    ...
    open func deleteRecommendRuleWithHTTPInfo(
        ...
        guard !indexName.isEmpty else {
            throw FlapjackError.invalidArgument("indexName", "deleteRecommendRule")
        }

        guard !objectID.isEmpty else {
            throw FlapjackError.invalidArgument("objectID", "deleteRecommendRule")
        }
    ...
    open func getRecommendRuleWithHTTPInfo(
        ...
        guard !indexName.isEmpty else {
            throw FlapjackError.invalidArgument("indexName", "getRecommendRule")
        }

        guard !objectID.isEmpty else {
            throw FlapjackError.invalidArgument("objectID", "getRecommendRule")
        }
    ...
    open func getRecommendStatusWithHTTPInfo(
        ...
        guard !indexName.isEmpty else {
            throw FlapjackError.invalidArgument("indexName", "getRecommendStatus")
        }
    ...
    open func searchRecommendRulesWithHTTPInfo(
        ...
        guard !indexName.isEmpty else {
            throw FlapjackError.invalidArgument("indexName", "searchRecommendRules")
        }
