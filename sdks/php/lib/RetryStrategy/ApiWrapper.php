...
use Flapjack\FlapjackSearch\Exceptions\AlgoliaException;
use Flapjack\FlapjackSearch\Exceptions\BadRequestException;
use Flapjack\FlapjackSearch\Exceptions\NotFoundException;
use Flapjack\FlapjackSearch\Exceptions\RetriableException;
use Flapjack\FlapjackSearch\Exceptions\TimeoutException;
use Flapjack\FlapjackSearch\Exceptions\UnreachableException;
use Flapjack\FlapjackSearch\Http\HttpClientInterface;
use Flapjack\FlapjackSearch\Http\Psr7\Request;
use Flapjack\FlapjackSearch\Http\Psr7\Uri;
use Flapjack\FlapjackSearch\RequestOptions\RequestOptions;
use Flapjack\FlapjackSearch\RequestOptions\RequestOptionsFactory;
use Flapjack\FlapjackSearch\Support\Helpers;
...
final class ApiWrapper implements ApiWrapperInterface
{
    ...
    public function __construct(
        ...
        $this->logger = $logger ?: Flapjack::getLogger();
    ...
    public function sendRequest(
        ...
        /**
         * Some POST methods in the Flapjack REST API uses the `read` transporter.
    ...
    {
        $this->logger->log($level, 'Flapjack API client: '.$message, $context);
    }
}
