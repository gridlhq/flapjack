...
/// <summary>
/// Configuration of a Flapjack index for Query Suggestions.
/// </summary>
public partial class SourceIndex
{
  ...
  /// Initializes a new instance of the SourceIndex class.
  /// </summary>
  /// <param name="indexName">Name of the Flapjack index (case-sensitive) to use as source for query suggestions. (required).</param>
  ...
  /// </summary>
  /// <value>Name of the Flapjack index (case-sensitive) to use as source for query suggestions.</value>
