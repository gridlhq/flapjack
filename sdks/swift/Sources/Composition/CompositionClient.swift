...
open class CompositionClient {
    ...
    open func deleteCompositionWithHTTPInfo(
        ...
        guard !compositionID.isEmpty else {
            throw FlapjackError.invalidArgument("compositionID", "deleteComposition")
        }
    ...
    open func deleteCompositionRuleWithHTTPInfo(
        ...
        guard !compositionID.isEmpty else {
            throw FlapjackError.invalidArgument("compositionID", "deleteCompositionRule")
        }

        guard !objectID.isEmpty else {
            throw FlapjackError.invalidArgument("objectID", "deleteCompositionRule")
        }
    ...
    open func getCompositionWithHTTPInfo(
        ...
        guard !compositionID.isEmpty else {
            throw FlapjackError.invalidArgument("compositionID", "getComposition")
        }
    ...
    open func getRuleWithHTTPInfo(
        ...
        guard !compositionID.isEmpty else {
            throw FlapjackError.invalidArgument("compositionID", "getRule")
        }
    ...
    open func getTaskWithHTTPInfo(
        ...
        guard !compositionID.isEmpty else {
            throw FlapjackError.invalidArgument("compositionID", "getTask")
        }
    ...
    open func putCompositionWithHTTPInfo(
        ...
        guard !compositionID.isEmpty else {
            throw FlapjackError.invalidArgument("compositionID", "putComposition")
        }
    ...
    open func putCompositionRuleWithHTTPInfo(
        ...
        guard !compositionID.isEmpty else {
            throw FlapjackError.invalidArgument("compositionID", "putCompositionRule")
        }

        guard !objectID.isEmpty else {
            throw FlapjackError.invalidArgument("objectID", "putCompositionRule")
        }
    ...
    open func saveRulesWithHTTPInfo(
        ...
        guard !compositionID.isEmpty else {
            throw FlapjackError.invalidArgument("compositionID", "saveRules")
        }
    ...
    open func searchWithHTTPInfo<T: Codable>(
        ...
        guard !compositionID.isEmpty else {
            throw FlapjackError.invalidArgument("compositionID", "search")
        }
    ...
    open func searchCompositionRulesWithHTTPInfo(
        ...
        guard !compositionID.isEmpty else {
            throw FlapjackError.invalidArgument("compositionID", "searchCompositionRules")
        }
    ...
    open func searchForFacetValuesWithHTTPInfo(
        ...
        guard !compositionID.isEmpty else {
            throw FlapjackError.invalidArgument("compositionID", "searchForFacetValues")
        }
    ...
    open func updateSortingStrategyCompositionWithHTTPInfo(
        ...
        guard !compositionID.isEmpty else {
            throw FlapjackError.invalidArgument("compositionID", "updateSortingStrategyComposition")
        }
