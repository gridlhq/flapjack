...
part 'recommend_search_params.g.dart';

@JsonSerializable()
final class RecommendSearchParams {
  /// Returns a new [RecommendSearchParams] instance.
  ...
  /// Characters and their normalized replacements. This overrides Algolia's default [normalization](https://www.flapjack.io/doc/guides/managing-results/optimize-search-results/handling-natural-languages-nlp/in-depth/normalization).
  ...
  Map<String, dynamic> toJson() => _$RecommendSearchParamsToJson(this);
