/** Code generated by OpenAPI Generator (https://openapi-generator.tech), manual changes will be lost - read more on
  * https://github.com/flapjackhq/api-clients-automation. DO NOT EDIT.
  */
package flapjacksearch.api

import flapjacksearch.search.Action._
import flapjacksearch.search.AddApiKeyResponse
import flapjacksearch.search.ApiKey
import flapjacksearch.search.ApiKeyOperation._
import flapjacksearch.search.AssignUserIdParams
import flapjacksearch.search.BatchAssignUserIdsParams
import flapjacksearch.search.BatchDictionaryEntriesParams
import flapjacksearch.search.BatchParams
import flapjacksearch.search.BatchResponse
import flapjacksearch.search.BatchWriteParams
import flapjacksearch.search.BrowseParams
import flapjacksearch.search.BrowseParamsObject
import flapjacksearch.search.BrowseResponse
import flapjacksearch.search.CreatedAtResponse
import flapjacksearch.search.DeleteApiKeyResponse
import flapjacksearch.search.DeleteByParams
import flapjacksearch.search.DeleteSourceResponse
import flapjacksearch.search.DeletedAtResponse
import flapjacksearch.search.DictionarySettingsParams
import flapjacksearch.search.DictionaryType._
import flapjacksearch.search.ErrorBase
import flapjacksearch.search.GetApiKeyResponse
import flapjacksearch.search.GetDictionarySettingsResponse
import flapjacksearch.search.GetLogsResponse
import flapjacksearch.search.GetObjectsParams
import flapjacksearch.search.GetObjectsResponse
import flapjacksearch.search.GetTaskResponse
import flapjacksearch.search.GetTopUserIdsResponse
import flapjacksearch.search.HasPendingMappingsResponse
import flapjacksearch.search.IndexSettings
import flapjacksearch.search.Languages
import flapjacksearch.search.ListApiKeysResponse
import flapjacksearch.search.ListClustersResponse
import flapjacksearch.search.ListIndicesResponse
import flapjacksearch.search.ListUserIdsResponse
import flapjacksearch.search.LogType._
import flapjacksearch.search.MultipleBatchResponse
import flapjacksearch.search.OperationIndexParams
import flapjacksearch.search.RemoveUserIdResponse
import flapjacksearch.search.ReplaceAllObjectsResponse
import flapjacksearch.search.ReplaceAllObjectsWithTransformationResponse
import flapjacksearch.search.ReplaceSourceResponse
import flapjacksearch.search.Rule
import flapjacksearch.search.SaveObjectResponse
import flapjacksearch.search.SaveSynonymResponse
import flapjacksearch.search.ScopeType._
import flapjacksearch.search.SearchDictionaryEntriesParams
import flapjacksearch.search.SearchDictionaryEntriesResponse
import flapjacksearch.search.SearchForFacetValuesRequest
import flapjacksearch.search.SearchForFacetValuesResponse
import flapjacksearch.search.SearchMethodParams
import flapjacksearch.search.SearchParams
import flapjacksearch.search.SearchResponse
import flapjacksearch.search.SearchResponses
import flapjacksearch.search.SearchRulesParams
import flapjacksearch.search.SearchRulesResponse
import flapjacksearch.search.SearchSynonymsParams
import flapjacksearch.search.SearchSynonymsResponse
import flapjacksearch.search.SearchUserIdsParams
import flapjacksearch.search.SearchUserIdsResponse
import flapjacksearch.search.SecuredApiKeyRestrictions
import flapjacksearch.search.SettingsResponse
import flapjacksearch.search.Source
import flapjacksearch.search.SynonymHit
import flapjacksearch.search.UpdateApiKeyResponse
import flapjacksearch.search.UpdatedAtResponse
import flapjacksearch.search.UpdatedAtWithObjectIdResponse
import flapjacksearch.search.UserId
import flapjacksearch.search.WatchResponse
import flapjacksearch.search._
import flapjacksearch.ApiClient
import flapjacksearch.api.SearchClient.hosts
import flapjacksearch.api.SearchClient.readTimeout
import flapjacksearch.api.SearchClient.writeTimeout
import flapjacksearch.api.SearchClient.connectTimeout
...
class SearchClient(
  ...
  /** If a record with the specified object ID exists, the existing record is replaced. Otherwise, a new record is added
    ...
    * operation](https://www.flapjack.io/doc/rest-api/search/save-object). To update _some_ attributes of an existing
    * record, use the [`partial` operation](https://www.flapjack.io/doc/rest-api/search/partial-update-object) instead.
    * To add, update, or replace multiple records, use the [`batch`
    * operation](https://www.flapjack.io/doc/rest-api/search/batch).
    *
    * Required API Key ACLs:
    *   - addObject
    *
  ...
  /** Adds, updates, or deletes records in one index with a single API request. Batching index updates reduces latency
    ...
    * limits](https://support.flapjack.io/hc/articles/4406975251089-Is-there-a-rate-limit-for-indexing-on-Flapjack).
    *
    * Required API Key ACLs:
    *   - addObject
    *
  ...
  /** This operation doesn't accept empty filters. This operation is resource-intensive. Use it only if you can't get
    ...
    * [`browse` operation](https://www.flapjack.io/doc/rest-api/search/browse), and then delete the records using the
    * [`batch` operation](https://www.flapjack.io/doc/rest-api/search/batch). This operation is subject to [indexing
    * rate limits](https://support.flapjack.io/hc/articles/4406975251089-Is-there-a-rate-limit-for-indexing-on-Flapjack).
    *
    * Required API Key ACLs:
    *   - deleteIndex
    *
  ...
  /** Deletes an index and all its settings. - Deleting an index doesn't delete its analytics data. - If you try to
    ...
    * replica
    * indices](https://www.flapjack.io/doc/guides/managing-results/refine-results/sorting/how-to/deleting-replicas).
    *
    * Required API Key ACLs:
    *   - deleteIndex
    *
  ...
  /** Deletes a record by its object ID. To delete more than one record, use the [`batch`
    * operation](https://www.flapjack.io/doc/rest-api/search/batch). To delete records matching a query, use the
    * [`deleteBy` operation](https://www.flapjack.io/doc/rest-api/search/delete-by).
    *
    * Required API Key ACLs:
    *   - deleteObject
    *
  ...
  /** Deletes a rule by its ID. To find the object ID for rules, use the [`search`
    * operation](https://www.flapjack.io/doc/rest-api/search/search-rules).
    *
    * Required API Key ACLs:
    *   - editSettings
    *
  ...
  /** Deletes a synonym by its ID. To find the object IDs of your synonyms, use the [`search`
    * operation](https://www.flapjack.io/doc/rest-api/search/search-synonyms).
    *
    * Required API Key ACLs:
    *   - editSettings
    *
  ...
  /** The request must be authenticated by an API key with the [`logs`
    * ACL](https://www.flapjack.io/doc/guides/security/api-keys/#access-control-list-acl). - Logs are held for the last
    * seven days. - Up to 1,000 API requests per server are logged. - This request counts towards your [operations
    * quota](https://support.flapjack.io/hc/articles/17245378392977-How-does-Flapjack-count-records-and-operations) but
  ...
  /** Retrieves one record by its object ID. To retrieve more than one record, use the [`objects`
    * operation](https://www.flapjack.io/doc/rest-api/search/get-objects).
    *
    * Required API Key ACLs:
    *   - search
    *
  ...
  /** Lists all indices in the current Flapjack application. The request follows any index restrictions of the API key
  ...
  /** Copies or moves (renames) an index within the same Flapjack application. Notes: - Existing destination indices are
    ...
    * limits](https://www.flapjack.io/doc/guides/scaling/flapjack-service-limits/#application-record-and-index-limits). -
    * For more information, see [Copy
    * indices](https://www.flapjack.io/doc/guides/sending-and-managing-data/manage-indices-and-apps/manage-indices/how-to/copy-indices).
    ...
    * indices](https://www.flapjack.io/doc/guides/sending-and-managing-data/manage-indices-and-apps/manage-indices/how-to/move-indices).
  ...
  /** Restores a deleted API key. Restoring resets the `validity` attribute to `0`. Flapjack stores up to 1,000 API keys
  ...
  /** Adds a record to an index or replaces it. - If the record doesn't have an object ID, a new record with an
    ...
    * a record, use the [`partial` operation](https://www.flapjack.io/doc/rest-api/search/partial-update-object). To
    * add, update, or replace multiple records, use the [`batch`
    * operation](https://www.flapjack.io/doc/rest-api/search/batch). This operation is subject to [indexing rate
    * limits](https://support.flapjack.io/hc/articles/4406975251089-Is-there-a-rate-limit-for-indexing-on-Flapjack).
    *
    * Required API Key ACLs:
    *   - addObject
  ...
  /** If a rule with the specified object ID doesn't exist, it's created. Otherwise, the existing rule is replaced. To
    ...
    * operation](https://www.flapjack.io/doc/rest-api/search/save-rules).
    *
    * Required API Key ACLs:
    *   - editSettings
    *
  ...
  /** Create or update multiple rules. If a rule with the specified object ID doesn't exist, Flapjack creates a new one.
  ...
  /** If a synonym with the specified object ID doesn't exist, Flapjack adds a new one. Otherwise, the existing synonym
    * is replaced. To add multiple synonyms in a single API request, use the [`batch`
    * operation](https://www.flapjack.io/doc/rest-api/search/save-synonyms).
    *
    * Required API Key ACLs:
    *   - editSettings
    *
  ...
  /** If a synonym with the `objectID` doesn't exist, Flapjack adds a new one. Otherwise, existing synonyms are replaced.
    * This operation is subject to [indexing rate
    * limits](https://support.flapjack.io/hc/articles/4406975251089-Is-there-a-rate-limit-for-indexing-on-Flapjack).
    *
    * Required API Key ACLs:
  ...
  /** Searches a single index and returns matching search results as hits. This method lets you retrieve up to 1,000
    * hits. If you need more, use the [`browse` operation](https://www.flapjack.io/doc/rest-api/search/browse) or
