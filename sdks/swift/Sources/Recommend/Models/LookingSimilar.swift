...
public struct LookingSimilar: Codable, JSONEncodable {
    public var model: LookingSimilarModel
    /// Unique record identifier.
    public var objectID: String
    public var fallbackParameters: FallbackParams?

    public init(model: LookingSimilarModel, objectID: String, fallbackParameters: FallbackParams? = nil) {
        self.model = model
...
extension LookingSimilar: Equatable {
    public static func ==(lhs: LookingSimilar, rhs: LookingSimilar) -> Bool {
        lhs.model == rhs.model &&
...
extension LookingSimilar: Hashable {
