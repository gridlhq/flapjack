...
from flapjacksearch.ingestion.models.on_demand_trigger import OnDemandTrigger
from flapjacksearch.ingestion.models.schedule_trigger import ScheduleTrigger
from flapjacksearch.ingestion.models.streaming_trigger import StreamingTrigger
from flapjacksearch.ingestion.models.subscription_trigger import SubscriptionTrigger
...
class Trigger(BaseModel):
    ...
    oneof_schema_1_validator: Optional[OnDemandTrigger] = Field(default=None)

    oneof_schema_2_validator: Optional[ScheduleTrigger] = Field(default=None)
    ...
    actual_instance: Union[
        OnDemandTrigger, ScheduleTrigger, StreamingTrigger, SubscriptionTrigger, None
    ] = None
