...
abstract class Configuration
{
    ...
    public function getFlapjackApiKey()
    {
     ...
     * @param mixed $apiKey
     */
    public function setFlapjackApiKey($apiKey)
    {
     ...
     *
     * @param string $flapjackAgent the user agent of the api client
     *
     * @return $this
     *
     * @throws \InvalidArgumentException
     */
    public function setFlapjackAgent($flapjackAgent)
    {
        if (!is_string($flapjackAgent)) {
            throw new \InvalidArgumentException('User-agent must be a string.');
        }

        $this->flapjackAgent = $flapjackAgent;
     ...
     */
    public function getFlapjackAgent()
    {
        return $this->flapjackAgent;
    }
