...
from flapjacksearch.search.models.search_for_facets import SearchForFacets
from flapjacksearch.search.models.search_for_hits import SearchForHits
...
class SearchQuery(BaseModel):
    ...
    oneof_schema_1_validator: Optional[SearchForHits] = Field(default=None)
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        try:
            instance.actual_instance = SearchForHits.from_json(json_str)

            return instance
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
        try:
            instance.actual_instance = SearchForFacets.from_json(json_str)
        ...
        raise ValueError(
            "No match found when deserializing the JSON string into SearchQuery with oneOf schemas: SearchForFacets, SearchForHits. Details: "
            + ", ".join(error_messages)
        )
