...
/// <summary>
/// Use this event to track when users make a purchase unrelated to a previous Flapjack request. For example, if you don't use Flapjack to build your category pages, use this event.  To track purchase events related to Flapjack requests, use the \"Purchased object IDs after search\" event.
/// </summary>
