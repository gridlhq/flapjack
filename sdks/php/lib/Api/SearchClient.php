...
use Flapjack\FlapjackSearch\Exceptions\ValidUntilNotFoundException;
use Flapjack\FlapjackSearch\Iterators\ObjectIterator;
use Flapjack\FlapjackSearch\Iterators\RuleIterator;
use Flapjack\FlapjackSearch\Iterators\SynonymIterator;
use Flapjack\FlapjackSearch\Model\Search\AddApiKeyResponse;
use Flapjack\FlapjackSearch\Model\Search\ApiKey;
use Flapjack\FlapjackSearch\Model\Search\AssignUserIdParams;
use Flapjack\FlapjackSearch\Model\Search\BatchAssignUserIdsParams;
use Flapjack\FlapjackSearch\Model\Search\BatchDictionaryEntriesParams;
use Flapjack\FlapjackSearch\Model\Search\BatchParams;
use Flapjack\FlapjackSearch\Model\Search\BatchResponse;
use Flapjack\FlapjackSearch\Model\Search\BatchWriteParams;
use Flapjack\FlapjackSearch\Model\Search\BrowseParams;
use Flapjack\FlapjackSearch\Model\Search\BrowseResponse;
use Flapjack\FlapjackSearch\Model\Search\CreatedAtResponse;
use Flapjack\FlapjackSearch\Model\Search\DeleteApiKeyResponse;
use Flapjack\FlapjackSearch\Model\Search\DeleteByParams;
use Flapjack\FlapjackSearch\Model\Search\DeletedAtResponse;
use Flapjack\FlapjackSearch\Model\Search\DeleteSourceResponse;
use Flapjack\FlapjackSearch\Model\Search\DictionarySettingsParams;
use Flapjack\FlapjackSearch\Model\Search\GetApiKeyResponse;
use Flapjack\FlapjackSearch\Model\Search\GetDictionarySettingsResponse;
use Flapjack\FlapjackSearch\Model\Search\GetLogsResponse;
use Flapjack\FlapjackSearch\Model\Search\GetObjectsParams;
use Flapjack\FlapjackSearch\Model\Search\GetObjectsResponse;
use Flapjack\FlapjackSearch\Model\Search\GetTaskResponse;
use Flapjack\FlapjackSearch\Model\Search\GetTopUserIdsResponse;
use Flapjack\FlapjackSearch\Model\Search\HasPendingMappingsResponse;
use Flapjack\FlapjackSearch\Model\Search\IndexSettings;
use Flapjack\FlapjackSearch\Model\Search\Languages;
use Flapjack\FlapjackSearch\Model\Search\ListApiKeysResponse;
use Flapjack\FlapjackSearch\Model\Search\ListClustersResponse;
use Flapjack\FlapjackSearch\Model\Search\ListIndicesResponse;
use Flapjack\FlapjackSearch\Model\Search\ListUserIdsResponse;
use Flapjack\FlapjackSearch\Model\Search\MultipleBatchResponse;
use Flapjack\FlapjackSearch\Model\Search\OperationIndexParams;
use Flapjack\FlapjackSearch\Model\Search\RemoveUserIdResponse;
use Flapjack\FlapjackSearch\Model\Search\ReplaceSourceResponse;
use Flapjack\FlapjackSearch\Model\Search\Rule;
use Flapjack\FlapjackSearch\Model\Search\SaveObjectResponse;
use Flapjack\FlapjackSearch\Model\Search\SaveSynonymResponse;
use Flapjack\FlapjackSearch\Model\Search\SearchDictionaryEntriesParams;
use Flapjack\FlapjackSearch\Model\Search\SearchDictionaryEntriesResponse;
use Flapjack\FlapjackSearch\Model\Search\SearchForFacetValuesRequest;
use Flapjack\FlapjackSearch\Model\Search\SearchForFacetValuesResponse;
use Flapjack\FlapjackSearch\Model\Search\SearchMethodParams;
use Flapjack\FlapjackSearch\Model\Search\SearchParams;
use Flapjack\FlapjackSearch\Model\Search\SearchResponse;
use Flapjack\FlapjackSearch\Model\Search\SearchResponses;
use Flapjack\FlapjackSearch\Model\Search\SearchRulesParams;
use Flapjack\FlapjackSearch\Model\Search\SearchRulesResponse;
use Flapjack\FlapjackSearch\Model\Search\SearchSynonymsParams;
use Flapjack\FlapjackSearch\Model\Search\SearchSynonymsResponse;
use Flapjack\FlapjackSearch\Model\Search\SearchUserIdsParams;
use Flapjack\FlapjackSearch\Model\Search\SearchUserIdsResponse;
use Flapjack\FlapjackSearch\Model\Search\SettingsResponse;
use Flapjack\FlapjackSearch\Model\Search\Source;
use Flapjack\FlapjackSearch\Model\Search\SynonymHit;
use Flapjack\FlapjackSearch\Model\Search\UpdateApiKeyResponse;
use Flapjack\FlapjackSearch\Model\Search\UpdatedAtResponse;
use Flapjack\FlapjackSearch\Model\Search\UpdatedAtWithObjectIdResponse;
use Flapjack\FlapjackSearch\Model\Search\UserId;
...
class SearchClient
{
    ...
    public static function createWithConfig(SearchConfig $config)
    {
        ...
        if (null !== $config->getTransformationRegion()) {
            $ingestionConfig = IngestionConfig::create($config->getAppId(), $config->getFlapjackApiKey(), $config->getTransformationRegion());
    ...
    public function waitForApiKey(
        ...
        return Helpers::retryForApiKeyUntil(
            ...
            $maxRetries,
            $timeout,
            'Flapjack\FlapjackSearch\Support\Helpers::linearTimeout',
            $requestOptions
        );
    }
