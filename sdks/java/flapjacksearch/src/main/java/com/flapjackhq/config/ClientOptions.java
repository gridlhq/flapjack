...
import com.flapjackhq.internal.HttpRequester;
import com.flapjackhq.utils.ExecutorUtils;
...
public final class ClientOptions implements ClientConfig {
  ...
  private final List<FlapjackAgent.Segment> algoliaAgentSegments;
  ...
  @Nonnull
  public List<FlapjackAgent.Segment> getFlapjackAgentSegments() {
  ...
  public static class Builder {
    ...
    private final List<FlapjackAgent.Segment> algoliaAgentSegments = new ArrayList<>();
    ...
    public Builder addFlapjackAgentSegment(FlapjackAgent.Segment segment) {
      this.algoliaAgentSegments.add(segment);
      return this;
    }

    public Builder addFlapjackAgentSegment(String value, String version) {
      FlapjackAgent.Segment segment = new FlapjackAgent.Segment(value, version);
      return addFlapjackAgentSegment(segment);
    }

    public Builder addFlapjackAgentSegment(String value) {
      FlapjackAgent.Segment segment = new FlapjackAgent.Segment(value);
      return addFlapjackAgentSegment(segment);
    }

    public Builder addFlapjackAgentSegments(List<FlapjackAgent.Segment> segments) {
