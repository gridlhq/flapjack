 ...
 * @category Class
 *
 * @description Use this event to track when users click items unrelated to a previous Flapjack request. For example, if you don't use Flapjack to build your category pages, use this event.  To track click events related to Flapjack requests, use the \"Clicked object IDs after search\" event.
 */
class ClickedObjectIDs extends AbstractModel implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    protected static $modelTypes = [
        'eventName' => 'string',
        'eventType' => '\Flapjack\FlapjackSearch\Model\Insights\ClickEvent',
        'index' => 'string',
        'objectIDs' => 'string[]',
        'userToken' => 'string',
