 ...
 * @category Class
 */
class Source extends AbstractModel implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    /**
    ...
    protected static $modelTypes = [
        'sourceID' => 'string',
        'type' => '\Flapjack\FlapjackSearch\Model\Ingestion\SourceType',
        'name' => 'string',
        'owner' => 'string',
        'input' => '\Flapjack\FlapjackSearch\Model\Ingestion\SourceInput',
