...
import flapjacksearch.recommend.AdvancedSyntaxFeatures._
import flapjacksearch.recommend.AlternativesAsExact._
import flapjacksearch.recommend.ExactOnSingleWordQuery._
import flapjacksearch.recommend.QueryType._
import flapjacksearch.recommend.RemoveWordsIfNoResults._
import flapjacksearch.recommend.SupportedLanguage._
...
/** FallbackParams
  ...
  *   scores](https://www.flapjack.io/doc/guides/managing-results/refine-results/filtering/in-depth/filter-scoring/#accumulating-scores-with-sumorfiltersscores).
  ...
  *   inside
  *   polygons](https://www.flapjack.io/doc/guides/managing-results/refine-results/geolocation/#filtering-inside-rectangular-or-polygonal-areas).
  ...
  *   contexts](https://www.flapjack.io/doc/guides/managing-results/rules/rules-overview/how-to/customize-search-results-by-platform/#whats-a-context)
  ...
  *   impact](https://www.flapjack.io/doc/guides/personalization/personalizing-results/in-depth/configuring-personalization/#understanding-personalization-impact).
  * @param userToken
  *   Unique pseudonymous or anonymous user identifier. This helps with analytics and click and conversion events. For
  *   more information, see [user token](https://www.flapjack.io/doc/guides/sending-events/concepts/usertoken).
  ...
  *   events](https://www.flapjack.io/doc/guides/sending-events/getting-started).
  * @param analytics
  *   Whether this search will be included in Analytics.
  * @param analyticsTags
  *   Tags to apply to the query for [segmenting analytics
  *   data](https://www.flapjack.io/doc/guides/search-analytics/guides/segments).
  ...
  *   Attributes used for [faceting](https://www.flapjack.io/doc/guides/managing-results/refine-results/faceting).
  ...
  * @param replicas
  *   Creates [replica
  *   indices](https://www.flapjack.io/doc/guides/managing-results/refine-results/sorting/in-depth/replicas). Replicas
  ...
  *   sorting](https://www.flapjack.io/doc/guides/managing-results/refine-results/sorting/in-depth/relevant-sort).
  ...
  *   or to [restrict
  *   access](https://www.flapjack.io/doc/guides/security/api-keys/how-to/user-restricted-access-to-data), but don't
  ...
  *   matches](https://www.flapjack.io/doc/guides/managing-results/optimize-search-results/typo-tolerance/in-depth/configuring-typo-tolerance/#turn-off-typo-tolerance-for-certain-words).
  *   This also turns off [word splitting and
  *   concatenation](https://www.flapjack.io/doc/guides/managing-results/optimize-search-results/handling-natural-languages-nlp/in-depth/splitting-and-concatenation)
  *   for the specified words.
  * @param attributesToTransliterate
  *   Attributes, for which you want to support [Japanese
  *   transliteration](https://www.flapjack.io/doc/guides/managing-results/optimize-search-results/handling-natural-languages-nlp/in-depth/language-specific-configurations/#japanese-transliteration-and-type-ahead).
  ...
  *   Searchable attributes to which Flapjack should apply [word
  *   segmentation](https://www.flapjack.io/doc/guides/managing-results/optimize-search-results/handling-natural-languages-nlp/how-to/customize-segmentation)
  ...
  *   Languages for language-specific processing steps, such as word detection and dictionary settings. **Always specify
  *   an indexing language.** If you don't specify an indexing language, the search engine uses all [supported
  *   languages](https://www.flapjack.io/doc/guides/managing-results/optimize-search-results/handling-natural-languages-nlp/in-depth/supported-languages),
  ...
  *   configuration](https://www.flapjack.io/doc/guides/managing-results/optimize-search-results/handling-natural-languages-nlp/in-depth/language-specific-configurations).
  * @param disablePrefixOnAttributes
  *   Searchable attributes for which you want to turn off [prefix
  *   matching](https://www.flapjack.io/doc/guides/managing-results/optimize-search-results/override-search-engine-defaults/#adjusting-prefix-search).
  ...
  *   filters](https://www.flapjack.io/doc/guides/managing-results/rules/detecting-intent/how-to/applying-a-custom-filter-for-a-specific-query/#numerical-filters).
  ...
  *   Control which non-alphanumeric characters are indexed. By default, Flapjack ignores [non-alphanumeric
  *   characters](https://www.flapjack.io/doc/guides/managing-results/optimize-search-results/typo-tolerance/how-to/how-to-search-in-hyphenated-attributes/#handling-non-alphanumeric-characters)
  ...
  *   With `separatorsToIndex`, Flapjack treats separator characters as separate words. For example, in a search for
  *   \"Disney+\", Flapjack considers \"Disney\" and \"+\" as two separate words.
  ...
  *   ranking criterion is turned off. With a non-empty list, Flapjack only returns results with matches in the selected
  ...
  *   attributes](https://www.flapjack.io/doc/guides/sending-and-managing-data/prepare-your-data/how-to/setting-searchable-attributes).
  ...
  *   Characters and their normalized replacements. This overrides Flapjack's default
  ...
  *   values](https://www.flapjack.io/doc/guides/managing-results/refine-results/faceting/#search-for-facet-values).
  * @param keepDiacriticsOnCharacters
  *   Characters for which diacritics should be preserved. By default, Flapjack removes diacritics from letters. For
  *   example, `é` becomes `e`. If this causes issues in your search, you can specify characters that should keep their
  *   diacritics.
  * @param customRanking
  *   Attributes to use as [custom ranking](https://www.flapjack.io/doc/guides/managing-results/must-do/custom-ranking).
  ...
  *   precision](https://www.flapjack.io/doc/guides/managing-results/must-do/custom-ranking/how-to/controlling-custom-ranking-metrics-precision)
  ...
  *   always included.
  * @param ranking
  *   Determines the order in which Flapjack returns your results. By default, each entry corresponds to a [ranking
  *   criteria](https://www.flapjack.io/doc/guides/managing-results/relevance-overview/in-depth/ranking-criteria). The
  ...
  *   attribute](https://www.flapjack.io/doc/guides/managing-results/refine-results/sorting/how-to/sort-by-attribute),
  ...
  *   testing](https://www.flapjack.io/doc/guides/ab-testing/what-is-ab-testing).
  ...
  *   indices](https://www.flapjack.io/doc/guides/managing-results/refine-results/sorting/in-depth/replicas/#what-are-virtual-replicas).
  ...
  *   [Highlighting and
  *   snippeting](https://www.flapjack.io/doc/guides/building-search-ui/ui-and-ux-patterns/highlighting-snippeting/js).
  ...
  *   typo](https://www.flapjack.io/doc/guides/managing-results/optimize-search-results/typo-tolerance/in-depth/configuring-typo-tolerance/#configuring-word-length-for-typos).
  ...
  *   typos](https://www.flapjack.io/doc/guides/managing-results/optimize-search-results/typo-tolerance/in-depth/configuring-typo-tolerance/#configuring-word-length-for-typos).
  ...
  *   tolerance](https://www.flapjack.io/doc/guides/managing-results/optimize-search-results/typo-tolerance). Attribute
  ...
  *   segmentation](https://www.flapjack.io/doc/guides/managing-results/optimize-search-results/handling-natural-languages-nlp/in-depth/language-specific-configurations/#splitting-compound-words).
  ...
  *   Determine which plurals and synonyms should be considered an exact matches By default, Flapjack treats singular and
  ...
  *   criterion](https://www.flapjack.io/doc/guides/managing-results/relevance-overview/in-depth/ranking-criteria/#proximity)
  ...
  *   display](https://www.flapjack.io/doc/guides/building-search-ui/ui-and-ux-patterns/facet-display/js).
  ...
  *   Whether this search will use [Dynamic Re-Ranking](https://www.flapjack.io/doc/guides/flapjack-ai/re-ranking) This
  *   setting only has an effect if you activated Dynamic Re-Ranking for this index in the Flapjack dashboard.
  */
case class FallbackParams(
