...
namespace Flapjack.Search.Models.Abtesting;
...
public partial class Variant
{
  ...
  /// <param name="noResultCount">Number of [searches without results](https://www.flapjack.io/doc/guides/search-analytics/concepts/metrics/#searches-without-results) for this variant. (required).</param>
  ...
  /// <summary>
  /// [Add-to-cart rate](https://www.flapjack.io/doc/guides/search-analytics/concepts/metrics/#add-to-cart-rate) for this variant.
  /// </summary>
  /// <value>[Add-to-cart rate](https://www.flapjack.io/doc/guides/search-analytics/concepts/metrics/#add-to-cart-rate) for this variant. </value>
  [JsonPropertyName("addToCartRate")]
  public double? AddToCartRate { get; set; }

  /// <summary>
  /// [Average click position](https://www.flapjack.io/doc/guides/search-analytics/concepts/metrics/#click-position) for this variant.
  /// </summary>
  /// <value>[Average click position](https://www.flapjack.io/doc/guides/search-analytics/concepts/metrics/#click-position) for this variant. </value>
  ...
  /// <summary>
  /// [Click-through rate](https://www.flapjack.io/doc/guides/search-analytics/concepts/metrics/#click-through-rate) for this variant.
  /// </summary>
  /// <value>[Click-through rate](https://www.flapjack.io/doc/guides/search-analytics/concepts/metrics/#click-through-rate) for this variant. </value>
  ...
  /// <summary>
  /// [Conversion rate](https://www.flapjack.io/doc/guides/search-analytics/concepts/metrics/#conversion-rate) for this variant.
  /// </summary>
  /// <value>[Conversion rate](https://www.flapjack.io/doc/guides/search-analytics/concepts/metrics/#conversion-rate) for this variant. </value>
  ...
  /// <summary>
  /// Number of [searches without results](https://www.flapjack.io/doc/guides/search-analytics/concepts/metrics/#searches-without-results) for this variant.
  /// </summary>
  /// <value>Number of [searches without results](https://www.flapjack.io/doc/guides/search-analytics/concepts/metrics/#searches-without-results) for this variant.</value>
  ...
  /// <summary>
  /// [Purchase rate](https://www.flapjack.io/doc/guides/search-analytics/concepts/metrics/#purchase-rate) for this variant.
  /// </summary>
  /// <value>[Purchase rate](https://www.flapjack.io/doc/guides/search-analytics/concepts/metrics/#purchase-rate) for this variant. </value>
