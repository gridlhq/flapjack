...
/// <summary>
/// Use this event to track when users convert on items unrelated to a previous Flapjack request. For example, if you don't use Flapjack to build your category pages, use this event.  To track conversion events related to Flapjack requests, use the \"Converted object IDs after search\" event.
/// </summary>
