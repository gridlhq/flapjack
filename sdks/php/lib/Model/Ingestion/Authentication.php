...
class Authentication extends AbstractModel implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    protected static $modelTypes = [
        ...
        'type' => '\Flapjack\FlapjackSearch\Model\Ingestion\AuthenticationType',
        'name' => 'string',
        'platform' => '\Flapjack\FlapjackSearch\Model\Ingestion\Platform',
        'owner' => 'string',
        'input' => '\Flapjack\FlapjackSearch\Model\Ingestion\AuthInputPartial',
        'createdAt' => 'string',
        'updatedAt' => 'string',
    ];
