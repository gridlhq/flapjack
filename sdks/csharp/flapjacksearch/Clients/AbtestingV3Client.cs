...
using Flapjack.Search.Models.AbtestingV3;
...
public interface IAbtestingV3Client
{
  ...
  /// <exception cref="Flapjack.Search.Exceptions.FlapjackUnreachableHostException">Thrown when the client failed to call the endpoint</exception>
  /// <returns>Task of Timeseries</returns>
  Task<FlapjackHttpResponse> GetTimeseriesWithHTTPInfoAsync(
    int id,
    string startDate = default,
    string endDate = default,
    List<MetricName> metric = default,
  ...
  /// <exception cref="Flapjack.Search.Exceptions.FlapjackUnreachableHostException">Thrown when the client failed to call the endpoint</exception>
  /// <returns>Timeseries</returns>
  FlapjackHttpResponse GetTimeseriesWithHTTPInfo(
    int id,
    string startDate = default,
    string endDate = default,
    List<MetricName> metric = default,
...
public partial class AbtestingV3Client : IAbtestingV3Client
{
  ...
  )
  {
    ...
    {
      _logger.LogInformation("Flapjack AbtestingV3 client is initialized.");
    }
  }
  ...
  /// <inheritdoc />
  public async Task<FlapjackHttpResponse> GetTimeseriesWithHTTPInfoAsync(
    int id,
    string startDate = default,
    string endDate = default,
    List<MetricName> metric = default,
  ...
  /// <inheritdoc />
  public FlapjackHttpResponse GetTimeseriesWithHTTPInfo(
    int id,
    string startDate = default,
    string endDate = default,
    List<MetricName> metric = default,
