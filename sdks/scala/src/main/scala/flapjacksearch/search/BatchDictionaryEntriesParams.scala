...
/** Request body for updating dictionary entries.
  *
  * @param clearExistingDictionaryEntries
  ...
  */
case class BatchDictionaryEntriesParams(
    clearExistingDictionaryEntries: Option[Boolean] = scala.None,
    requests: Seq[BatchDictionaryEntriesRequest]
)
