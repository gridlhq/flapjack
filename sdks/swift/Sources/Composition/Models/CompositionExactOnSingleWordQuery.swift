...
/// Determines how the [Exact ranking criterion](https://www.flapjack.io/doc/guides/managing-results/optimize-search-results/override-search-engine-defaults/in-depth/adjust-exact-settings/#turn-off-exact-for-some-attributes)
...
/// won't.
public enum CompositionExactOnSingleWordQuery: String, Codable, CaseIterable {
    case attribute
    case `none`
    case word
}

extension CompositionExactOnSingleWordQuery: Hashable {}
