...
namespace Flapjack\FlapjackSearch\Model\Recommend;

use Flapjack\FlapjackSearch\Model\AbstractModel;
use Flapjack\FlapjackSearch\Model\ModelInterface;

/**
 * RecommendSearchParams Class Doc Comment.
 *
 * @category Class
 *
 * @description Search parameters for filtering the recommendations.
 */
class RecommendSearchParams extends AbstractModel implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    /**
    ...
    protected static $modelTypes = [
        'similarQuery' => 'string',
        'filters' => 'string',
        'facetFilters' => '\Flapjack\FlapjackSearch\Model\Recommend\FacetFilters',
        'optionalFilters' => '\Flapjack\FlapjackSearch\Model\Recommend\OptionalFilters',
        'numericFilters' => '\Flapjack\FlapjackSearch\Model\Recommend\NumericFilters',
        'tagFilters' => '\Flapjack\FlapjackSearch\Model\Recommend\TagFilters',
        ...
        'aroundRadius' => '\Flapjack\FlapjackSearch\Model\Recommend\AroundRadius',
        'aroundPrecision' => '\Flapjack\FlapjackSearch\Model\Recommend\AroundPrecision',
        'minimumAroundRadius' => 'int',
        'insideBoundingBox' => '\Flapjack\FlapjackSearch\Model\Recommend\InsideBoundingBox',
        'insidePolygon' => 'float[][]',
        'naturalLanguages' => '\Flapjack\FlapjackSearch\Model\Recommend\SupportedLanguage[]',
        'ruleContexts' => 'string[]',
        ...
        'indexLanguages' => '\Flapjack\FlapjackSearch\Model\Recommend\SupportedLanguage[]',
        ...
        'typoTolerance' => '\Flapjack\FlapjackSearch\Model\Recommend\TypoTolerance',
        'allowTyposOnNumericTokens' => 'bool',
        'disableTypoToleranceOnAttributes' => 'string[]',
        'ignorePlurals' => '\Flapjack\FlapjackSearch\Model\Recommend\IgnorePlurals',
        'removeStopWords' => '\Flapjack\FlapjackSearch\Model\Recommend\RemoveStopWords',
        'queryLanguages' => '\Flapjack\FlapjackSearch\Model\Recommend\SupportedLanguage[]',
        'decompoundQuery' => 'bool',
        'enableRules' => 'bool',
        'enablePersonalization' => 'bool',
        'queryType' => '\Flapjack\FlapjackSearch\Model\Recommend\QueryType',
        'removeWordsIfNoResults' => '\Flapjack\FlapjackSearch\Model\Recommend\RemoveWordsIfNoResults',
        'advancedSyntax' => 'bool',
        'optionalWords' => '\Flapjack\FlapjackSearch\Model\Recommend\OptionalWords',
        'disableExactOnAttributes' => 'string[]',
        'exactOnSingleWordQuery' => '\Flapjack\FlapjackSearch\Model\Recommend\ExactOnSingleWordQuery',
        'alternativesAsExact' => '\Flapjack\FlapjackSearch\Model\Recommend\AlternativesAsExact[]',
        'advancedSyntaxFeatures' => '\Flapjack\FlapjackSearch\Model\Recommend\AdvancedSyntaxFeatures[]',
        'distinct' => '\Flapjack\FlapjackSearch\Model\Recommend\Distinct',
        ...
        'renderingContent' => '\Flapjack\FlapjackSearch\Model\Recommend\RenderingContent',
        'enableReRanking' => 'bool',
        'reRankingApplyFilter' => '\Flapjack\FlapjackSearch\Model\Recommend\ReRankingApplyFilter',
    ];
     ...
     * Sets indexLanguages.
     *
     * @param null|SupportedLanguage[] $indexLanguages Languages for language-specific processing steps, such as word detection and dictionary settings.  **Always specify an indexing language.** If you don't specify an indexing language, the search engine uses all [supported languages](https://www.algolia.com/doc/guides/managing-results/optimize-search-results/handling-natural-languages-nlp/in-depth/supported-languages), or the languages you specified with the `ignorePlurals` or `removeStopWords` parameters. This can lead to unexpected search results. For more information, see [Language-specific configuration](https://www.algolia.com/doc/guides/managing-results/optimize-search-results/handling-natural-languages-nlp/in-depth/language-specific-configurations).
     *
     * @return self
     */
