...
/**
 * RecommendUpdatedAtResponse Class Doc Comment.
 *
 * @category Class
 *
 * @description Response, taskID, and update timestamp.
 */
class RecommendUpdatedAtResponse extends AbstractModel implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    /**
