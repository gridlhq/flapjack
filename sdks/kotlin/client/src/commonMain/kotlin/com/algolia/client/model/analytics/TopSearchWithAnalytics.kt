 ...
 * @param averageClickPosition Average position of a clicked search result in the list of search
 *   results. If null, Algolia didn't receive any search requests with `clickAnalytics` set to true.
 * @param clickPositions List of positions in the search results and clicks associated with this
 *   search.
