...
public struct PersonalizationClientConfiguration: BaseConfiguration, Credentials {
    ...
    public init(
        ...
        guard let hosts else {
            ...
            guard let url = URL(string: "https://personalization.{region}.flapjack.io".replacingOccurrences(
                of: "{region}",
