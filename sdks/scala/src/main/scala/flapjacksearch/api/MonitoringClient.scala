...
import flapjacksearch.monitoring.BadRequest
import flapjacksearch.monitoring.ErrorBase
import flapjacksearch.monitoring.Forbidden
import flapjacksearch.monitoring.IncidentsResponse
import flapjacksearch.monitoring.IndexingTimeResponse
import flapjacksearch.monitoring.InfrastructureResponse
import flapjacksearch.monitoring.InventoryResponse
import flapjacksearch.monitoring.LatencyResponse
import flapjacksearch.monitoring.Metric._
import flapjacksearch.monitoring.Period._
import flapjacksearch.monitoring.StatusResponse
import flapjacksearch.monitoring.Unauthorized
import flapjacksearch.monitoring._
import flapjacksearch.ApiClient
import flapjacksearch.api.MonitoringClient.hosts
import flapjacksearch.api.MonitoringClient.readTimeout
import flapjacksearch.api.MonitoringClient.writeTimeout
import flapjacksearch.api.MonitoringClient.connectTimeout
...
object MonitoringClient {
  ...
  private def hosts(): Seq[Host] = {
    List(
      Host("status.flapjack.io", Set(CallType.Read, CallType.Write))
    )
  }
}
...
class MonitoringClient(
  ...
  /** Retrieves metrics related to your Flapjack infrastructure, aggregated over a selected time window. Access to this
    * API is available as part of the [Premium or Elevate plans](https://www.flapjack.io/pricing). You must authenticate
  ...
  /** Retrieves the servers that belong to clusters. The response depends on whether you authenticate your API request:
    * \- With authentication, the response lists the servers assigned to your Flapjack application's cluster. - Without
    * authentication, the response lists the servers for all Flapjack clusters.
    */
  def getServers(
      requestOptions: Option[RequestOptions] = None
