 ...
 * @category Class
 *
 * @description Click event after a Flapjack request. Use this event to track when users click items in the search results. If you're building your category pages with Flapjack, you'll also use this event.
 */
