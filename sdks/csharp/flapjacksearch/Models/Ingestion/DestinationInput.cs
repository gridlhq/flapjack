...
public partial class DestinationInput
{
  ...
  /// Initializes a new instance of the DestinationInput class.
  /// </summary>
  /// <param name="indexName">Flapjack index name (case-sensitive). (required).</param>
