...
import 'package:flapjack_client_core/src/flapjack_exception.dart';
...
import 'package:flapjack_client_core/src/transport/dio/agent_interceptor.dart';
import 'package:flapjack_client_core/src/transport/dio/auth_interceptor.dart';
...
import 'package:flapjack_client_core/src/version.dart';
  ...
  DioRequester({
    ...
    _client = Dio(
      BaseOptions(
        ...
        _authInterceptor,
        AgentInterceptor(
          agent: FlapjackAgent(packageVersion)
    ...
    try {
      ...
      switch (e.type) {
        ...
        case DioExceptionType.receiveTimeout:
          throw FlapjackTimeoutException(e);
