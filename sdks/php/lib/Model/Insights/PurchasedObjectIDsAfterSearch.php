 ...
 * @category Class
 *
 * @description Use this event to track when users make a purchase after a previous Flapjack request. If you're building your category pages with Flapjack, you'll also use this event.
 */
