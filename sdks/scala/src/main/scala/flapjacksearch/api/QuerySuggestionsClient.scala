...
import flapjacksearch.querysuggestions.BaseResponse
import flapjacksearch.querysuggestions.ConfigStatus
import flapjacksearch.querysuggestions.Configuration
import flapjacksearch.querysuggestions.ConfigurationResponse
import flapjacksearch.querysuggestions.ConfigurationWithIndex
import flapjacksearch.querysuggestions.ErrorBase
import flapjacksearch.querysuggestions.LogFile
import flapjacksearch.querysuggestions._
import flapjacksearch.ApiClient
import flapjacksearch.api.QuerySuggestionsClient.hosts
import flapjacksearch.api.QuerySuggestionsClient.readTimeout
import flapjacksearch.api.QuerySuggestionsClient.writeTimeout
import flapjacksearch.api.QuerySuggestionsClient.connectTimeout
...
object QuerySuggestionsClient {
  ...
  private def hosts(region: String): Seq[Host] = {
    ...
    val url = "query-suggestions.{region}.flapjack.io".replace("{region}", region)
