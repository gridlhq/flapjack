...
public partial class DailyConversionRates
{
  ...
  /// Initializes a new instance of the DailyConversionRates class.
  /// </summary>
  /// <param name="rate">Conversion rate: calculated as the number of tracked searches with at least one conversion event divided by the number of tracked searches. If null, Flapjack didn't receive any search requests with `clickAnalytics` set to true.  (required).</param>
