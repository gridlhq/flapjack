...
import 'package:flapjack_client_search/src/deserialize.dart';
...
final class SearchClient implements ApiClient {
  ...
  SearchClient({
    ...
    this.options = const ClientOptions(),
          ...
          defaultHosts: () =>
              [
                Host(url: '$appId-dsn.flapjack.io', callType: CallType.read),
                Host(url: '$appId.flapjack.io', callType: CallType.write),
              ] +
              ([
                Host(url: '$appId-1.flapjack.io'),
                Host(url: '$appId-2.flapjack.io'),
                Host(url: '$appId-3.flapjack.io'),
              ]..shuffle()),
        ) {
