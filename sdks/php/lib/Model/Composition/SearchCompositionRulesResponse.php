...
/**
 * SearchCompositionRulesResponse Class Doc Comment.
 *
 * @category Class
 */
class SearchCompositionRulesResponse extends AbstractModel implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    /**
    ...
    protected static $modelTypes = [
        'hits' => '\Flapjack\FlapjackSearch\Model\Composition\CompositionRule[]',
        'nbHits' => 'int',
        'page' => 'int',
        'nbPages' => 'int',
    ];
     ...
     * Sets hits.
     *
     * @param CompositionRule[] $hits composition rules that matched the search criteria
     *
     * @return self
     */
     ...
     * Sets nbHits.
     *
     * @param int $nbHits number of composition rules that matched the search criteria
     *
     * @return self
     */
