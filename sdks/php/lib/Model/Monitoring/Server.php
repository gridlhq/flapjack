...
class Server extends AbstractModel implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    protected static $modelTypes = [
        'name' => 'string',
        'region' => '\Flapjack\FlapjackSearch\Model\Monitoring\Region',
        'isSlave' => 'bool',
        'isReplica' => 'bool',
        'cluster' => 'string',
        'status' => '\Flapjack\FlapjackSearch\Model\Monitoring\ServerStatus',
        'type' => '\Flapjack\FlapjackSearch\Model\Monitoring\Type',
    ];
