...
/** Use this event to track when users add items to their shopping cart after a previous Flapjack request. If you're
  * building your category pages with Flapjack, you'll also use this event.
  *
  * @param eventName
