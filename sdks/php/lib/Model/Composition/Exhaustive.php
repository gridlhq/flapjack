...
class Exhaustive extends AbstractModel implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * Sets facetsCount.
     *
     * @param null|bool $facetsCount Whether the facet count is exhaustive (`true`) or approximate (`false`). See the [related discussion](https://support.algolia.com/hc/articles/4406975248145-Why-are-my-facet-and-hit-counts-not-accurate).
     *
     * @return self
     */
