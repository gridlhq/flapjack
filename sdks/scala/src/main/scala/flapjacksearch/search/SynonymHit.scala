...
import flapjacksearch.search.SynonymType._
...
/** Synonym object.
  ...
  *   [`onewaysynonym`s](https://www.flapjack.io/doc/guides/managing-results/optimize-search-results/adding-synonyms/in-depth/one-way-synonyms)).
  * @param word
  *   Word or phrase to appear in query strings (for [`altcorrection1` and
  *   `altcorrection2`](https://www.flapjack.io/doc/guides/managing-results/optimize-search-results/adding-synonyms/in-depth/synonyms-alternative-corrections)).
  * @param corrections
  *   Words to be matched in records.
  * @param placeholder
  *   [Placeholder
  *   token](https://www.flapjack.io/doc/guides/managing-results/optimize-search-results/adding-synonyms/in-depth/synonyms-placeholders)
