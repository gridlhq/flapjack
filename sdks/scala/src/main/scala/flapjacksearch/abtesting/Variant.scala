/** A/B Testing API ## Base URLs Base URLs for the A/B testing API: - `https://analytics.us.flapjack.io` -
  ...
  */
package flapjacksearch.abtesting
...
/** Variant
  ...
  * @param addToCartRate
  *   [Add-to-cart rate](https://www.flapjack.io/doc/guides/search-analytics/concepts/metrics/#add-to-cart-rate) for
  *   this variant.
  * @param averageClickPosition
  *   [Average click position](https://www.flapjack.io/doc/guides/search-analytics/concepts/metrics/#click-position) for
  *   this variant.
  * @param clickCount
  *   Number of click events for this variant.
  * @param clickThroughRate
  *   [Click-through rate](https://www.flapjack.io/doc/guides/search-analytics/concepts/metrics/#click-through-rate) for
  *   this variant.
  * @param conversionCount
  *   Number of click events for this variant.
  * @param conversionRate
  *   [Conversion rate](https://www.flapjack.io/doc/guides/search-analytics/concepts/metrics/#conversion-rate) for this
  *   variant.
  * @param currencies
  *   A/B test currencies.
  * @param description
  ...
  *   results](https://www.flapjack.io/doc/guides/search-analytics/concepts/metrics/#searches-without-results) for this
  *   variant.
  * @param purchaseCount
  *   Number of purchase events for this variant.
  * @param purchaseRate
  *   [Purchase rate](https://www.flapjack.io/doc/guides/search-analytics/concepts/metrics/#purchase-rate) for this
  *   variant.
  * @param searchCount
