...
import flapjacksearch.composition.BatchParams
import flapjacksearch.composition.Composition
import flapjacksearch.composition.CompositionRule
import flapjacksearch.composition.CompositionRulesBatchParams
import flapjacksearch.composition.ErrorBase
import flapjacksearch.composition.GetTaskResponse
import flapjacksearch.composition.ListCompositionsResponse
import flapjacksearch.composition.MultipleBatchResponse
import flapjacksearch.composition.RequestBody
import flapjacksearch.composition.RulesMultipleBatchResponse
import flapjacksearch.composition.SearchCompositionRulesParams
import flapjacksearch.composition.SearchCompositionRulesResponse
import flapjacksearch.composition.SearchForFacetValuesRequest
import flapjacksearch.composition.SearchForFacetValuesResponse
import flapjacksearch.composition.SearchResponse
import flapjacksearch.composition.TaskIDResponse
import flapjacksearch.composition._
import flapjacksearch.ApiClient
import flapjacksearch.api.CompositionClient.hosts
import flapjacksearch.api.CompositionClient.readTimeout
import flapjacksearch.api.CompositionClient.writeTimeout
import flapjacksearch.api.CompositionClient.connectTimeout
...
class CompositionClient(
  ...
  /** Retrieves a rule by its ID. To find the object ID of a rule, use the [`search`
    * operation](https://www.flapjack.io/doc/rest-api/composition/search-composition-rules).
    *
    * Required API Key ACLs:
    *   - editSettings
    *   - settings
  ...
  /** Updates the \"sortingStrategy\" field of an existing composition. This endpoint lets you create a new sorting
    ...
    * applied to the specified composition within the current Flapjack application and returns a taskID that can be used
