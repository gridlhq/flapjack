...
/// <summary>
/// Use this event to track when users add items to their shopping cart unrelated to a previous Flapjack request. For example, if you don't use Flapjack to build your category pages, use this event.  To track add-to-cart events related to Flapjack requests, use the \"Added to cart object IDs after search\" event.
/// </summary>
public partial class AddedToCartObjectIDs
{
  ...
  /// <param name="userToken">Anonymous or pseudonymous user identifier.  Don't use personally identifiable information in user tokens. For more information, see [User token](https://www.flapjack.io/doc/guides/sending-events/concepts/usertoken).  (required).</param>
  public AddedToCartObjectIDs(
    string eventName,
  ...
  /// <summary>
  /// Anonymous or pseudonymous user identifier.  Don't use personally identifiable information in user tokens. For more information, see [User token](https://www.flapjack.io/doc/guides/sending-events/concepts/usertoken).
  /// </summary>
  /// <value>Anonymous or pseudonymous user identifier.  Don't use personally identifiable information in user tokens. For more information, see [User token](https://www.flapjack.io/doc/guides/sending-events/concepts/usertoken). </value>
  [JsonPropertyName("userToken")]
  public string UserToken { get; set; }

  /// <summary>
  /// Identifier for authenticated users.  When the user signs in, you can get an identifier from your system and send it as `authenticatedUserToken`. This lets you keep using the `userToken` from before the user signed in, while providing a reliable way to identify users across sessions. Don't use personally identifiable information in user tokens. For more information, see [User token](https://www.flapjack.io/doc/guides/sending-events/concepts/usertoken).
  /// </summary>
