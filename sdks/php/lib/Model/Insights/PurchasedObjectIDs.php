 ...
 * @category Class
 *
 * @description Use this event to track when users make a purchase unrelated to a previous Flapjack request. For example, if you don't use Flapjack to build your category pages, use this event.  To track purchase events related to Flapjack requests, use the \"Purchased object IDs after search\" event.
 */
class PurchasedObjectIDs extends AbstractModel implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    protected static $modelTypes = [
        'eventName' => 'string',
        'eventType' => '\Flapjack\FlapjackSearch\Model\Insights\ConversionEvent',
        'eventSubtype' => '\Flapjack\FlapjackSearch\Model\Insights\PurchaseEvent',
        'index' => 'string',
        'objectIDs' => 'string[]',
        'userToken' => 'string',
        'authenticatedUserToken' => 'string',
        'currency' => 'string',
        'objectData' => '\Flapjack\FlapjackSearch\Model\Insights\ObjectData[]',
        'timestamp' => 'int',
        'value' => '\Flapjack\FlapjackSearch\Model\Insights\Value',
    ];
