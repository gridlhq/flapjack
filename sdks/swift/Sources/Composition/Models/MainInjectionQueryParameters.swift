...
public struct MainInjectionQueryParameters: Codable, JSONEncodable {
    ...
    /// facets with the `disjunctive` modifier. For more information, see [facets](https://www.flapjack.io/doc/guides/managing-results/refine-results/faceting/#contextual-facet-values-and-counts)
    /// and [disjunctive faceting for Smart Groups](https://www.flapjack.io/doc/guides/managing-results/compositions/search-based-groups#facets-including-disjunctive-faceting).
