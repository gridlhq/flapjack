...
class DictionaryEntry extends AbstractModel implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    protected static $modelTypes = [
        'objectID' => 'string',
        'language' => '\Flapjack\FlapjackSearch\Model\Search\SupportedLanguage',
        'word' => 'string',
        'words' => 'string[]',
        'decomposition' => 'string[]',
        'state' => '\Flapjack\FlapjackSearch\Model\Search\DictionaryEntryState',
        'type' => '\Flapjack\FlapjackSearch\Model\Search\DictionaryEntryType',
    ];
