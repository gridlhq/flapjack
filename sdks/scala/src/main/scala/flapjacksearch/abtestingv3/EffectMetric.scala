...
object EffectMetric {
  ...
  case object NoResultsRate extends EffectMetric {
    override def toString = "noResultsRate"
  }
  val values: Seq[EffectMetric] = Seq(AddToCartRate, ClickThroughRate, ConversionRate, PurchaseRate, NoResultsRate)
