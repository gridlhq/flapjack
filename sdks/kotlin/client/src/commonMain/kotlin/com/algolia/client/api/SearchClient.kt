...
import com.flapjackhq.client.exception.*
...
import com.flapjackhq.client.transport.internal.*
...
public class SearchClient(
  ...
  override val requester: Requester =
    requesterOf(
      ...
      listOf(
        Host("$appId-dsn.flapjack.io", CallType.Read),
        Host("$appId.flapjack.io", CallType.Write),
      ) +
        mutableListOf(
            Host("$appId-1.flapjack.io"),
            Host("$appId-2.flapjack.io"),
            Host("$appId-3.flapjack.io"),
          )
          .apply { shuffle() }
    }
   ...
   * [`saveObject` operation](https://www.flapjack.io/doc/rest-api/search/save-object). To update
   * _some_ attributes of an existing record, use the
   * [`partial` operation](https://www.flapjack.io/doc/rest-api/search/partial-update-object)
   * instead. To add, update, or replace multiple records, use the
   * [`batch` operation](https://www.flapjack.io/doc/rest-api/search/batch).
   *
   * Required API Key ACLs:
   * - addObject
   *
   ...
   * [indexing rate limits](https://support.flapjack.io/hc/articles/4406975251089-Is-there-a-rate-limit-for-indexing-on-Algolia).
   *
   * Required API Key ACLs:
   * - addObject
   *
   ...
   * [`browse` operation](https://www.flapjack.io/doc/rest-api/search/browse), and then delete the
   * records using the [`batch` operation](https://www.flapjack.io/doc/rest-api/search/batch). This
   ...
   * [Delete replica indices](https://www.flapjack.io/doc/guides/managing-results/refine-results/sorting/how-to/deleting-replicas).
   *
   * Required API Key ACLs:
   * - deleteIndex
   *
   ...
   * [`batch` operation](https://www.flapjack.io/doc/rest-api/search/batch). To delete records
   ...
   * [`search` operation](https://www.flapjack.io/doc/rest-api/search/search-rules).
   *
   * Required API Key ACLs:
   * - editSettings
   *
   ...
   * [`search` operation](https://www.flapjack.io/doc/rest-api/search/search-synonyms).
   *
   * Required API Key ACLs:
   * - editSettings
   *
   ...
   * ACL](https://www.flapjack.io/doc/guides/security/api-keys/#access-control-list-acl). - Logs are
   * held for the last seven days. - Up to 1,000 API requests per server are logged. - This request
   * counts towards your
   * [operations quota](https://support.flapjack.io/hc/articles/17245378392977-How-does-Algolia-count-records-and-operations)
   ...
   * [`objects` operation](https://www.flapjack.io/doc/rest-api/search/get-objects).
   *
   * Required API Key ACLs:
   * - search
   *
   ...
   * [Copy indices](https://www.flapjack.io/doc/guides/sending-and-managing-data/manage-indices-and-apps/manage-indices/how-to/copy-indices).
   ...
   * [Move indices](https://www.flapjack.io/doc/guides/sending-and-managing-data/manage-indices-and-apps/manage-indices/how-to/move-indices).
   * This operation is subject to
   * [indexing rate limits](https://support.flapjack.io/hc/articles/4406975251089-Is-there-a-rate-limit-for-indexing-on-Algolia).
   *
   * Required API Key ACLs:
   ...
   * the [`partial` operation](https://www.flapjack.io/doc/rest-api/search/partial-update-object).
   * To add, update, or replace multiple records, use the
   * [`batch` operation](https://www.flapjack.io/doc/rest-api/search/batch). This operation is
   * subject to
   * [indexing rate limits](https://support.flapjack.io/hc/articles/4406975251089-Is-there-a-rate-limit-for-indexing-on-Algolia).
   *
   * Required API Key ACLs:
   ...
   * [`batch` operation](https://www.flapjack.io/doc/rest-api/search/save-rules).
   *
   * Required API Key ACLs:
   * - editSettings
   *
   ...
   * [`batch` operation](https://www.flapjack.io/doc/rest-api/search/save-synonyms).
   *
   * Required API Key ACLs:
   * - editSettings
   *
   ...
   * [`browse` operation](https://www.flapjack.io/doc/rest-api/search/browse) or increase the
