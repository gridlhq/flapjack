...
public sealed interface FacetFilters {
  ...
  @Serializable @JvmInline public value class StringValue(public val value: String) : FacetFilters
...
internal class FacetFiltersSerializer :
  JsonContentPolymorphicSerializer<FacetFilters>(FacetFilters::class) {
