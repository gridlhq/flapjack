...
extension SearchSearchParamsObject: Equatable {
    public static func ==(lhs: SearchSearchParamsObject, rhs: SearchSearchParamsObject) -> Bool {
        lhs.query == rhs.query &&
...
extension SearchSearchParamsObject: Hashable {
