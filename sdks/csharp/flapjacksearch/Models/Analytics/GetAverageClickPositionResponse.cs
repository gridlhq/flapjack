...
public partial class GetAverageClickPositionResponse
{
  ...
  /// Initializes a new instance of the GetAverageClickPositionResponse class.
  /// </summary>
  /// <param name="average">Average position of a clicked search result in the list of search results. If null, Flapjack didn't receive any search requests with `clickAnalytics` set to true.  (required).</param>
