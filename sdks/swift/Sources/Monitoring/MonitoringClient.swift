...
open class MonitoringClient {
    ...
    open func getClusterIncidentsWithHTTPInfo(
        ...
        guard !clusters.isEmpty else {
            throw FlapjackError.invalidArgument("clusters", "getClusterIncidents")
        }
    ...
    open func getClusterStatusWithHTTPInfo(
        ...
        guard !clusters.isEmpty else {
            throw FlapjackError.invalidArgument("clusters", "getClusterStatus")
        }
    ...
    open func getIndexingTimeWithHTTPInfo(
        ...
        guard !clusters.isEmpty else {
            throw FlapjackError.invalidArgument("clusters", "getIndexingTime")
        }
    ...
    open func getLatencyWithHTTPInfo(
        ...
        guard !clusters.isEmpty else {
            throw FlapjackError.invalidArgument("clusters", "getLatency")
        }
    ...
    // API is available as part of the [Premium or Elevate plans](https://www.flapjack.io/pricing). You must
    // authenticate
    ...
    open func getReachabilityWithHTTPInfo(
        ...
        guard !clusters.isEmpty else {
            throw FlapjackError.invalidArgument("clusters", "getReachability")
        }
