...
namespace Flapjack.Search.Models.QuerySuggestions;
...
public partial class ConfigurationResponse
{
  ...
  /// Initializes a new instance of the ConfigurationResponse class.
  /// </summary>
  /// <param name="appID">Flapjack application ID to which this Query Suggestions configuration belongs. (required).</param>
  /// <param name="indexName">Name of the Query Suggestions index (case-sensitive). (required).</param>
  /// <param name="sourceIndices">Flapjack indices from which to get the popular searches for query suggestions. (required).</param>
  ...
  /// </summary>
  /// <value>Flapjack application ID to which this Query Suggestions configuration belongs.</value>
  ...
  /// </summary>
  /// <value>Flapjack indices from which to get the popular searches for query suggestions.</value>
