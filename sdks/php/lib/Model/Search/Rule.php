...
class Rule extends AbstractModel implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    protected static $modelTypes = [
        'objectID' => 'string',
        'conditions' => '\Flapjack\FlapjackSearch\Model\Search\Condition[]',
        'consequence' => '\Flapjack\FlapjackSearch\Model\Search\Consequence',
        'description' => 'string',
        'enabled' => 'bool',
        'validity' => '\Flapjack\FlapjackSearch\Model\Search\TimeRange[]',
        'tags' => 'string[]',
        'scope' => 'string',
    ];
