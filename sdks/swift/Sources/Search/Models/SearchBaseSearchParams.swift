...
public struct SearchBaseSearchParams: Codable, JSONEncodable {
    /// Search query.
...
extension SearchBaseSearchParams: Equatable {
    public static func ==(lhs: SearchBaseSearchParams, rhs: SearchBaseSearchParams) -> Bool {
        lhs.query == rhs.query &&
...
extension SearchBaseSearchParams: Hashable {
