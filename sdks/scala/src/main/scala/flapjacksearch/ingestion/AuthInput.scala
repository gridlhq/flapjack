...
object AuthInputSerializer extends Serializer[AuthInput] {
  override def deserialize(implicit format: Formats): PartialFunction[(TypeInfo, JValue), AuthInput] = {
    ...
    case (TypeInfo(clazz, _), json) if clazz == classOf[AuthInput] =>
      json match {
        ...
        case value: JObject                                    => Extraction.extract[AuthFlapjack](value)
        case value: JObject                                    => Extraction.extract[AuthFlapjackInsights](value)
  ...
  override def serialize(implicit format: Formats): PartialFunction[Any, JValue] = { case value: AuthInput =>
    value match {
      ...
      case value: AuthFlapjack              => Extraction.decompose(value)(format - this)
      case value: AuthFlapjackInsights      => Extraction.decompose(value)(format - this)
      case AuthInput.MapOfStringString(value) =>
