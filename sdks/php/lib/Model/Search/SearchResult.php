...
class SearchResult extends AbstractModel implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    protected static $modelTypes = [
        ...
        'exhaustive' => '\Flapjack\FlapjackSearch\Model\Search\Exhaustive',
        'appliedRules' => 'object[]',
        'exhaustiveFacetsCount' => 'bool',
        'exhaustiveNbHits' => 'bool',
        'exhaustiveTypo' => 'bool',
        'facets' => 'array<string,array<string,int>>',
        'facetsStats' => 'array<string,\Flapjack\FlapjackSearch\Model\Search\FacetStats>',
        'index' => 'string',
        'indexUsed' => 'string',
        'message' => 'string',
        'nbSortedHits' => 'int',
        ...
        'redirect' => '\Flapjack\FlapjackSearch\Model\Search\Redirect',
        ...
        'nbPages' => 'int',
        'hitsPerPage' => 'int',
        'hits' => '\Flapjack\FlapjackSearch\Model\Search\Hit[]',
        'query' => 'string',
        'params' => 'string',
        'facetHits' => '\Flapjack\FlapjackSearch\Model\Search\FacetHits[]',
    ];
