...
/**
 * SearchResultsItem Class Doc Comment.
 *
 * @category Class
 */
class SearchResultsItem extends AbstractModel implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    /**
    ...
    protected static $modelTypes = [
        ...
        'exhaustive' => '\Flapjack\FlapjackSearch\Model\Composition\Exhaustive',
        'appliedRules' => 'object[]',
        'exhaustiveFacetsCount' => 'bool',
        'exhaustiveNbHits' => 'bool',
        'exhaustiveTypo' => 'bool',
        'facets' => 'array<string,array<string,int>>',
        'facetsStats' => 'array<string,\Flapjack\FlapjackSearch\Model\Composition\FacetStats>',
        'index' => 'string',
        'indexUsed' => 'string',
        'message' => 'string',
        'nbSortedHits' => 'int',
        ...
        'redirect' => '\Flapjack\FlapjackSearch\Model\Composition\Redirect',
        ...
        'hits' => '\Flapjack\FlapjackSearch\Model\Composition\Hit[]',
        'hitsPerPage' => 'int',
        'nbHits' => 'int',
        'nbPages' => 'int',
        'page' => 'int',
        'params' => 'string',
        'query' => 'string',
        'compositions' => 'array<string,\Flapjack\FlapjackSearch\Model\Composition\ResultsCompositionInfoResponse>',
    ];
