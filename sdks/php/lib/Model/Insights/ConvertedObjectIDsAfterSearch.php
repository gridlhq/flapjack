 ...
 * @category Class
 *
 * @description Use this event to track when users convert after a previous Flapjack request. For example, a user clicks on an item in the search results to view the product detail page. Then, the user adds the item to their shopping cart.  If you're building your category pages with Flapjack, you'll also use this event.
 */
