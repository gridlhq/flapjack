...
from flapjacksearch.analytics.models.top_hit_with_revenue_analytics import (
...
class TopHitsResponseWithRevenueAnalytics(BaseModel):
    ...
    hits: List[TopHitWithRevenueAnalytics]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        obj["hits"] = (
            [TopHitWithRevenueAnalytics.from_dict(_item) for _item in obj["hits"]]
