...
/**
 * CompositionRule Class Doc Comment.
 *
 * @category Class
 */
class CompositionRule extends AbstractModel implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    /**
    ...
    protected static $modelTypes = [
        'objectID' => 'string',
        'conditions' => '\Flapjack\FlapjackSearch\Model\Composition\Condition[]',
        'consequence' => '\Flapjack\FlapjackSearch\Model\Composition\CompositionRuleConsequence',
        'description' => 'string',
        'enabled' => 'bool',
        'validity' => '\Flapjack\FlapjackSearch\Model\Composition\TimeRange[]',
        'tags' => 'string[]',
    ];
