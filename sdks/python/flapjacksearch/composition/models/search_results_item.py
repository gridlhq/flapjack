...
from flapjacksearch.composition.models.exhaustive import Exhaustive
from flapjacksearch.composition.models.facet_stats import FacetStats
from flapjacksearch.composition.models.hit import Hit
from flapjacksearch.composition.models.redirect import Redirect
from flapjacksearch.composition.models.rendering_content import RenderingContent
from flapjacksearch.composition.models.results_composition_info_response import (
...
class SearchResultsItem(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SearchResultsItem from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SearchResultsItem from a dict"""
        if obj is None:
            return None
        ...
        obj["compositions"] = (
            dict(
                (_k, ResultsCompositionInfoResponse.from_dict(_v))
                for _k, _v in obj["compositions"].items()
            )
            if obj.get("compositions") is not None
            else None
        )
