 ...
 * @category Class
 *
 * @description API request body for updating a task using the V1 shape. Use methods and types that don't contain the V1 suffix.
 */
class TaskUpdateV1 extends AbstractModel implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    protected static $modelTypes = [
        ...
        'trigger' => '\Flapjack\FlapjackSearch\Model\Ingestion\TriggerUpdateInput',
