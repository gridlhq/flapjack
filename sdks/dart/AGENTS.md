...
- ❌ **WRONG**: `origin .../algolia/flapjacksearch-client-dart.git` → STOP! This is the PUBLIC repository

**If you're in `flapjacksearch-client-dart`**: Do NOT make changes here. All changes must go through `api-clients-automation`. PRs and commits made directly to the public repo will be discarded on next release.
...
'!clients/flapjacksearch-client-dart/**',                        // Hand-written by default
'clients/flapjacksearch-client-dart/packages/*/pubspec.yaml',    // Generated
'clients/flapjacksearch-client-dart/packages/*/lib/src/api/**',  // Generated
'clients/flapjacksearch-client-dart/packages/*/lib/src/model/**', // Generated
```
...
- `packages/flapjacksearch/lib/flapjacksearch.dart` - Main export
...
- Run: `yarn cli format dart clients/flapjacksearch-client-dart`
...
└── flapjacksearch/         # Umbrella package
```
...
yarn cli format dart clients/flapjacksearch-client-dart

# From client directory (requires Dart SDK + Melos)
cd clients/flapjacksearch-client-dart
