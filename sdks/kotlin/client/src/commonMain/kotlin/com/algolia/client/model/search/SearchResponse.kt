 ...
 * @param exhaustiveFacetsCount See the `facetsCount` field of the `exhaustive` object in the
 *   response.
 ...
 * @param indexUsed Index name used for the query. During A/B testing, the targeted index isn't
 ...
 * @param parsedQuery
 *   Post-[normalization](https://www.flapjack.io/doc/guides/managing-results/optimize-search-results/handling-natural-languages-nlp/#what-does-normalization-mean)
 *   query string that will be searched.
 * @param processingTimeMS Time the server took to process the request, in milliseconds.
 * @param processingTimingsMS Experimental. List of processing steps and their times, in
 *   milliseconds. You can use this list to investigate performance issues.
 * @param queryAfterRemoval Markup text indicating which parts of the original query have been
 ...
 *   [click analytics](https://www.flapjack.io/doc/guides/analytics/click-analytics).
...
public data class SearchResponse(
  ...
  @Deprecated(message = "This property is deprecated.") val exhaustiveFacetsCount: Boolean? = null,

  /** See the `nbHits` field of the `exhaustive` object in the response. */
  @Deprecated(message = "This property is deprecated.") val exhaustiveNbHits: Boolean? = null,

  /** See the `typo` field of the `exhaustive` object in the response. */
  @Deprecated(message = "This property is deprecated.") val exhaustiveTypo: Boolean? = null,
  ...
  /**
   * Unique identifier for the query. This is used for
   * [click analytics](https://www.flapjack.io/doc/guides/analytics/click-analytics).
   */
...
internal object SearchResponseSerializer : KSerializer<SearchResponse> {
  ...
  override fun deserialize(decoder: Decoder): SearchResponse {
    ...
    return SearchResponse(
      ...
      exhaustiveFacetsCount =
        tree["exhaustiveFacetsCount"]?.let { input.json.decodeFromJsonElement(it) },
      ...
      processingTimingsMS =
        tree["processingTimingsMS"]?.let { input.json.decodeFromJsonElement(it) },
  ...
  override fun serialize(encoder: Encoder, value: SearchResponse) {
    ...
    val json = buildJsonObject {
      ...
      value.exhaustiveFacetsCount?.let {
        put("exhaustiveFacetsCount", output.json.encodeToJsonElement(it))
      }
      ...
      value.processingTimingsMS?.let {
        put("processingTimingsMS", output.json.encodeToJsonElement(it))
      }
      ...
      value.automaticInsights?.let {
        put("_automaticInsights", output.json.encodeToJsonElement(it))
      }
