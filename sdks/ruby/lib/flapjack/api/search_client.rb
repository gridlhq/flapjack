  ...
  class SearchClient
    ...
    def self.create(app_id, api_key, opts = {})
      ...
      hosts += 1
        .upto(3)
        .map do |i|
          Transport::StatefulHost.new("#{app_id}-#{i}.flapjacknet.io", accept: CallType::READ | CallType::WRITE)
        end
        .shuffle

      config = Flapjack::Configuration.new(app_id, api_key, hosts, "Search", opts)
      new(config)
    end
    ...
    def self.generate_secured_api_key(parent_api_key, restrictions = {})
      ...
      url_encoded_restrictions = Flapjack::Transport
    ...
    def self.get_secured_api_key_remaining_validity(secured_api_key)
      ...
      if matches.nil?
        raise FlapjackError, "The SecuredApiKey doesn't have a validUntil parameter."
      end
