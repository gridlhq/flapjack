...
public struct SearchResultsItem<T: Codable>: Codable, JSONEncodable {
...
extension SearchResultsItem: Equatable where T: Equatable {
    public static func ==(lhs: SearchResultsItem<T>, rhs: SearchResultsItem<T>) -> Bool {
...
extension SearchResultsItem: Hashable where T: Hashable {
