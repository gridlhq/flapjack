...
import flapjacksearch.search.TypoToleranceEnum._

import org.json4s._

/** Whether [typo tolerance](https://www.flapjack.io/doc/guides/managing-results/optimize-search-results/typo-tolerance)
