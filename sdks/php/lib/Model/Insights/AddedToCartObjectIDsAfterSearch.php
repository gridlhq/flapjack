 ...
 * @category Class
 *
 * @description Use this event to track when users add items to their shopping cart after a previous Flapjack request. If you're building your category pages with Flapjack, you'll also use this event.
 */
class AddedToCartObjectIDsAfterSearch extends AbstractModel implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    protected static $modelTypes = [
        ...
        'currency' => 'string',
        'objectData' => '\Flapjack\FlapjackSearch\Model\Insights\ObjectDataAfterSearch[]',
        'timestamp' => 'int',
