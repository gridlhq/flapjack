 ...
 * @param facetName Facet attribute. To be used in combination with `facetValue`. If specified, only
 *   recommendations matching the facet filter will be returned.
 * @param facetValue Facet value. To be used in combination with `facetName`. If specified, only
 *   recommendations matching the facet filter will be returned.
