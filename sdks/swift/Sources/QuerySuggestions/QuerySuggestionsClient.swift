...
open class QuerySuggestionsClient {
    ...
    open func deleteConfigWithHTTPInfo(
        ...
        guard !indexName.isEmpty else {
            throw FlapjackError.invalidArgument("indexName", "deleteConfig")
        }
    ...
    open func getConfigWithHTTPInfo(
        ...
        guard !indexName.isEmpty else {
            throw FlapjackError.invalidArgument("indexName", "getConfig")
        }
    ...
    open func getConfigStatusWithHTTPInfo(
        ...
        guard !indexName.isEmpty else {
            throw FlapjackError.invalidArgument("indexName", "getConfigStatus")
        }
    ...
    open func getLogFileWithHTTPInfo(
        ...
        guard !indexName.isEmpty else {
            throw FlapjackError.invalidArgument("indexName", "getLogFile")
        }
    ...
    open func updateConfigWithHTTPInfo(
        ...
        guard !indexName.isEmpty else {
            throw FlapjackError.invalidArgument("indexName", "updateConfig")
        }
