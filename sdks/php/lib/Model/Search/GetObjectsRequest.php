 ...
 */
class GetObjectsRequest extends AbstractModel implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    /**
     ...
     *
     * @param null|string[] $attributesToRetrieve Attributes to retrieve. If not specified, all retrievable attributes are returned.
     *
     * @return self
     */
