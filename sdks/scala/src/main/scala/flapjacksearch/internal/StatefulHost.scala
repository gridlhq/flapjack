...
import flapjacksearch.config.{CallType, Host}
import flapjacksearch.internal.util.currentDateTime

import java.time.OffsetDateTime
import scala.collection.Set

private[flapjacksearch] class StatefulHost(private val host: Host) {
