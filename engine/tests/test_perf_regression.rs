...
///
/// These tests are gated behind `#[cfg(not(debug_assertions))]` because
/// latency thresholds are only meaningful in optimized (release) builds.
/// Debug builds are 10-100x slower and produce noisy, meaningless results
/// on shared CI runners.

// Everything below requires --release; in debug builds this file compiles
// to an empty test binary (0 tests).
