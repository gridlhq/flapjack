...
/** Effect of the rule. For more information, see
  * [Consequences](https://www.flapjack.io/doc/guides/managing-results/rules/rules-overview/#consequences).
  *
  * @param promote
  ...
  *   `color: red` but the user filters for `color: blue`, the \"red\" record won't be shown. > In the Flapjack
  ...
  *   rules](https://www.flapjack.io/doc/guides/managing-results/rules/merchandising-and-promoting/how-to/promote-hits/#promote-results-matching-active-filters).
  * @param hide
