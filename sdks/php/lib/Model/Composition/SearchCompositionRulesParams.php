...
/**
 * SearchCompositionRulesParams Class Doc Comment.
 *
 * @category Class
 *
 * @description Composition Rules search parameters.
 */
class SearchCompositionRulesParams extends AbstractModel implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    /**
    ...
    protected static $modelTypes = [
        'query' => 'string',
        'anchoring' => '\Flapjack\FlapjackSearch\Model\Composition\Anchoring',
        'context' => 'string',
        'page' => 'int',
        'hitsPerPage' => 'int',
        'enabled' => 'bool',
     ...
     * Sets context.
     *
     * @param null|string $context only return composition rules that match the context (exact match)
     *
     * @return self
     */
     ...
     * Sets enabled.
     *
     * @param null|bool $enabled If `true`, return only enabled composition rules. If `false`, return only inactive composition rules. By default, _all_ composition rules are returned.
     *
     * @return self
     */
