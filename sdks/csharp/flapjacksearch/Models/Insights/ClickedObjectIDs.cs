...
/// <summary>
/// Use this event to track when users click items unrelated to a previous Flapjack request. For example, if you don't use Flapjack to build your category pages, use this event.  To track click events related to Flapjack requests, use the \"Clicked object IDs after search\" event.
/// </summary>
