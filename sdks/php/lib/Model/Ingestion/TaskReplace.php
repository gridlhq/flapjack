...
class TaskReplace extends AbstractModel implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    protected static $modelTypes = [
        ...
        'subscriptionAction' => '\Flapjack\FlapjackSearch\Model\Ingestion\ActionType',
        'cron' => 'string',
        'enabled' => 'bool',
        'failureThreshold' => 'int',
        'input' => '\Flapjack\FlapjackSearch\Model\Ingestion\TaskInput',
        'cursor' => 'string',
        'notifications' => '\Flapjack\FlapjackSearch\Model\Ingestion\Notifications',
        'policies' => '\Flapjack\FlapjackSearch\Model\Ingestion\Policies',
    ];
