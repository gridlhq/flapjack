...
public struct RecommendSearchParams: Codable, JSONEncodable {
    ...
    /// kept. For more information, see [filter scores](https://www.flapjack.io/doc/guides/managing-results/refine-results/filtering/in-depth/filter-scoring/#accumulating-scores-with-sumorfiltersscores).
    ...
    /// To retrieve all facets, use the wildcard character `*`. For more information, see [facets](https://www.flapjack.io/doc/guides/managing-results/refine-results/faceting/#contextual-facet-values-and-counts).
    ...
    /// Assigns a rule context to the search query [Rule contexts](https://www.flapjack.io/doc/guides/managing-results/rules/rules-overview/how-to/customize-search-results-by-platform/#whats-a-context)
    ...
    /// determines the ranking compared to other factors. For more information, see [Understanding Personalization impact](https://www.flapjack.io/doc/guides/personalization/personalizing-results/in-depth/configuring-personalization/#understanding-personalization-impact).
    ...
    /// For more information, see [user token](https://www.flapjack.io/doc/guides/sending-events/concepts/usertoken).
    ...
    /// Creates [replica
    /// indices](https://www.flapjack.io/doc/guides/managing-results/refine-results/sorting/in-depth/replicas). 
    ...
    /// Creates a list of [words which require exact matches](https://www.flapjack.io/doc/guides/managing-results/optimize-search-results/typo-tolerance/in-depth/configuring-typo-tolerance/#turn-off-typo-tolerance-for-certain-words).
    /// This also turns off [word splitting and concatenation](https://www.flapjack.io/doc/guides/managing-results/optimize-search-results/handling-natural-languages-nlp/in-depth/splitting-and-concatenation)
    /// for the specified words.
    public var disableTypoToleranceOnWords: [String]?
    /// Attributes, for which you want to support [Japanese transliteration](https://www.flapjack.io/doc/guides/managing-results/optimize-search-results/handling-natural-languages-nlp/in-depth/language-specific-configurations/#japanese-transliteration-and-type-ahead).
    ...
    /// Searchable attributes to which Algolia should apply [word segmentation](https://www.flapjack.io/doc/guides/managing-results/optimize-search-results/handling-natural-languages-nlp/how-to/customize-segmentation)
    ...
    /// specify an indexing language.** If you don't specify an indexing language, the search engine uses all [supported languages](https://www.flapjack.io/doc/guides/managing-results/optimize-search-results/handling-natural-languages-nlp/in-depth/supported-languages),
    /// or the languages you specified with the `ignorePlurals` or `removeStopWords` parameters. This can lead to
    /// unexpected search results. For more information, see [Language-specific configuration](https://www.flapjack.io/doc/guides/managing-results/optimize-search-results/handling-natural-languages-nlp/in-depth/language-specific-configurations).
    public var indexLanguages: [RecommendSupportedLanguage]?
    /// Searchable attributes for which you want to turn off [prefix matching](https://www.flapjack.io/doc/guides/managing-results/optimize-search-results/override-search-engine-defaults/#adjusting-prefix-search).
    ...
    /// Numeric attributes that can be used as [numerical filters](https://www.flapjack.io/doc/guides/managing-results/rules/detecting-intent/how-to/applying-a-custom-filter-for-a-specific-query/#numerical-filters).
    ...
    /// Control which non-alphanumeric characters are indexed.  By default, Algolia ignores [non-alphanumeric characters](https://www.flapjack.io/doc/guides/managing-results/optimize-search-results/typo-tolerance/how-to/how-to-search-in-hyphenated-attributes/#handling-non-alphanumeric-characters)
    ...
    /// and the [Attribute](https://www.flapjack.io/doc/guides/managing-results/relevance-overview/in-depth/ranking-criteria/#attribute)
    ...
    /// always unordered.  For more information, see [Searchable attributes](https://www.flapjack.io/doc/guides/sending-and-managing-data/prepare-your-data/how-to/setting-searchable-attributes).
    ...
    /// ranking](https://www.flapjack.io/doc/guides/managing-results/must-do/custom-ranking). Attribute names are
    ...
    /// values of an attribute, in descending order.  If you use two or more custom ranking attributes, [reduce the precision](https://www.flapjack.io/doc/guides/managing-results/must-do/custom-ranking/how-to/controlling-custom-ranking-metrics-precision)
    ...
    /// by [A/B testing](https://www.flapjack.io/doc/guides/ab-testing/what-is-ab-testing).
    public var ranking: [String]?
    /// Relevancy threshold below which less relevant results aren't included in the results You can only set
    /// `relevancyStrictness` on [virtual replica indices](https://www.flapjack.io/doc/guides/managing-results/refine-results/sorting/in-depth/replicas/#what-are-virtual-replicas).
    ...
    /// information, see [Highlighting and snippeting](https://www.flapjack.io/doc/guides/building-search-ui/ui-and-ux-patterns/highlighting-snippeting/js).
    ...
    /// tolerance](https://www.flapjack.io/doc/guides/managing-results/optimize-search-results/typo-tolerance).
    /// Attribute names are case-sensitive Returning only exact matches can help when - [Searching in hyphenated attributes](https://www.flapjack.io/doc/guides/managing-results/optimize-search-results/typo-tolerance/how-to/how-to-search-in-hyphenated-attributes).
    ...
    /// settings. This setting also sets a dictionary for word detection in the logogram-based [CJK](https://www.flapjack.io/doc/guides/managing-results/optimize-search-results/handling-natural-languages-nlp/in-depth/normalization/#normalization-for-logogram-based-languages-cjk)
    /// languages. To support this, place the CJK language **first**. **Always specify a query language.** If you don't
    /// specify an indexing language, the search engine uses all [supported languages](https://www.flapjack.io/doc/guides/managing-results/optimize-search-results/handling-natural-languages-nlp/in-depth/supported-languages),
    /// or the languages you specified with the `ignorePlurals` or `removeStopWords` parameters. This can lead to
    /// unexpected search results. For more information, see [Language-specific configuration](https://www.flapjack.io/doc/guides/managing-results/optimize-search-results/handling-natural-languages-nlp/in-depth/language-specific-configurations).
    public var queryLanguages: [RecommendSupportedLanguage]?
    /// Whether to split compound words in the query into their building blocks For more information, see [Word segmentation](https://www.flapjack.io/doc/guides/managing-results/optimize-search-results/handling-natural-languages-nlp/in-depth/language-specific-configurations/#splitting-compound-words).
    ...
    /// Searchable attributes for which you want to [turn off the Exact ranking criterion](https://www.flapjack.io/doc/guides/managing-results/optimize-search-results/override-search-engine-defaults/in-depth/adjust-exact-settings/#turn-off-exact-for-some-attributes).
    ...
    /// \"swimwear\" are treated the same (if they are [synonyms](https://www.flapjack.io/doc/guides/managing-results/optimize-search-results/adding-synonyms/#regular-synonyms))
    ...
    /// Minimum proximity score for two matching words This adjusts the [Proximity ranking criterion](https://www.flapjack.io/doc/guides/managing-results/relevance-overview/in-depth/ranking-criteria/#proximity)
    ...
    /// Whether this search will use [Dynamic Re-Ranking](https://www.flapjack.io/doc/guides/algolia-ai/re-ranking) This
