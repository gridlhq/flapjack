 ...
 * @category Class
 *
 * @description Use this event to track when users add items to their shopping cart unrelated to a previous Flapjack request. For example, if you don't use Flapjack to build your category pages, use this event.  To track add-to-cart events related to Flapjack requests, use the \"Added to cart object IDs after search\" event.
 */
class AddedToCartObjectIDs extends AbstractModel implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    protected static $modelTypes = [
        ...
        'eventSubtype' => '\Flapjack\FlapjackSearch\Model\Insights\AddToCartEvent',
        'index' => 'string',
        'objectIDs' => 'string[]',
        'userToken' => 'string',
