...
class RecommendRule extends AbstractModel implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    protected static $modelTypes = [
        'metadata' => '\Flapjack\FlapjackSearch\Model\Recommend\RuleMetadata',
        'objectID' => 'string',
        'condition' => '\Flapjack\FlapjackSearch\Model\Recommend\Condition',
        'consequence' => '\Flapjack\FlapjackSearch\Model\Recommend\Consequence',
        'description' => 'string',
        'enabled' => 'bool',
        'validity' => '\Flapjack\FlapjackSearch\Model\Recommend\TimeRange[]',
    ];
