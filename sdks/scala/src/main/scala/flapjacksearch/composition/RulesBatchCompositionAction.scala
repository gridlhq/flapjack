...
/** RulesBatchCompositionAction
  */
sealed trait RulesBatchCompositionAction

trait RulesBatchCompositionActionTrait extends RulesBatchCompositionAction

object RulesBatchCompositionAction {}

object RulesBatchCompositionActionSerializer extends Serializer[RulesBatchCompositionAction] {
  override def deserialize(implicit
      format: Formats
  ): PartialFunction[(TypeInfo, JValue), RulesBatchCompositionAction] = {
  ...
  override def serialize(implicit format: Formats): PartialFunction[Any, JValue] = {
    case value: RulesBatchCompositionAction =>
      value match {
        case value: CompositionRule             => Extraction.decompose(value)(format - this)
        case value: DeleteCompositionRuleAction => Extraction.decompose(value)(format - this)
      }
  }
}
