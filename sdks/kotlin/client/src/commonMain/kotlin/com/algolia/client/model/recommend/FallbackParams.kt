 ...
 * FallbackParams
 *
 * @param similarQuery Keywords to be used instead of the search query to conduct a more broader
 *   search Using the `similarQuery` parameter changes other settings - `queryType` is set to
 *   `prefixNone`. - `removeStopWords` is set to true. - `words` is set as the first ranking
 *   criterion. - All remaining words are treated as `optionalWords` Since the `similarQuery` is
 *   supposed to do a broad search, they usually return many results. Combine it with `filters` to
 ...
 *   [filter scores](https://www.flapjack.io/doc/guides/managing-results/refine-results/filtering/in-depth/filter-scoring/#accumulating-scores-with-sumorfiltersscores).
 ...
 *   [facets](https://www.flapjack.io/doc/guides/managing-results/refine-results/faceting/#contextual-facet-values-and-counts).
 ...
 *   [filtering inside polygons](https://www.flapjack.io/doc/guides/managing-results/refine-results/geolocation/#filtering-inside-rectangular-or-polygonal-areas).
 ...
 *   [Rule contexts](https://www.flapjack.io/doc/guides/managing-results/rules/rules-overview/how-to/customize-search-results-by-platform/#whats-a-context)
 ...
 *   more information, see
 *   [Understanding Personalization impact](https://www.flapjack.io/doc/guides/personalization/personalizing-results/in-depth/configuring-personalization/#understanding-personalization-impact).
 ...
 *   [user token](https://www.flapjack.io/doc/guides/sending-events/concepts/usertoken).
 ...
 *   [click and conversion events](https://www.flapjack.io/doc/guides/sending-events/getting-started).
 * @param analytics Whether this search will be included in Analytics.
 * @param analyticsTags Tags to apply to the query for
 *   [segmenting analytics data](https://www.flapjack.io/doc/guides/search-analytics/guides/segments).
 ...
 *   [faceting](https://www.flapjack.io/doc/guides/managing-results/refine-results/faceting). Facets
 *   are attributes that let you categorize search results. They can be used for filtering search
 *   results. By default, no attribute is used for faceting. Attribute names are case-sensitive.
 *   **Modifiers** - `filterOnly(\"ATTRIBUTE\")`. Allows the attribute to be used as a filter but
 *   doesn't evaluate the facet values. - `searchable(\"ATTRIBUTE\")`. Allows searching for facet
 *   values. - `afterDistinct(\"ATTRIBUTE\")`. Evaluates the facet count _after_ deduplication with
 ...
 * @param replicas Creates
 *   [replica indices](https://www.flapjack.io/doc/guides/managing-results/refine-results/sorting/in-depth/replicas).
 ...
 *   records and are optimized for
 *   [Relevant sorting](https://www.flapjack.io/doc/guides/managing-results/refine-results/sorting/in-depth/relevant-sort).
 * @param paginationLimitedTo Maximum number of search results that can be obtained through
 *   pagination. Higher pagination limits might slow down your search. For pagination limits above
 *   1,000, the sorting of results beyond the 1,000th hit can't be guaranteed.
 * @param unretrievableAttributes Attributes that can't be retrieved at query time. This can be
 *   useful if you want to use an attribute for ranking or to
 *   [restrict access](https://www.flapjack.io/doc/guides/security/api-keys/how-to/user-restricted-access-to-data),
 *   but don't want to include it in the search results. Attribute names are case-sensitive.
 * @param disableTypoToleranceOnWords Creates a list of
 *   [words which require exact matches](https://www.flapjack.io/doc/guides/managing-results/optimize-search-results/typo-tolerance/in-depth/configuring-typo-tolerance/#turn-off-typo-tolerance-for-certain-words).
 *   This also turns off
 *   [word splitting and concatenation](https://www.flapjack.io/doc/guides/managing-results/optimize-search-results/handling-natural-languages-nlp/in-depth/splitting-and-concatenation)
 *   for the specified words.
 * @param attributesToTransliterate Attributes, for which you want to support
 *   [Japanese transliteration](https://www.flapjack.io/doc/guides/managing-results/optimize-search-results/handling-natural-languages-nlp/in-depth/language-specific-configurations/#japanese-transliteration-and-type-ahead).
 ...
 *   case-sensitive.
 * @param camelCaseAttributes Attributes for which to split
 *   [camel case](https://wikipedia.org/wiki/Camel_case) words. Attribute names are case-sensitive.
 * @param decompoundedAttributes Searchable attributes to which Algolia should apply
 *   [word segmentation](https://www.flapjack.io/doc/guides/managing-results/optimize-search-results/handling-natural-languages-nlp/how-to/customize-segmentation)
 ...
 *   Norwegian (`no`). Decompounding doesn't work for words with
 ...
 *   [supported languages](https://www.flapjack.io/doc/guides/managing-results/optimize-search-results/handling-natural-languages-nlp/in-depth/supported-languages),
 ...
 *   [Language-specific configuration](https://www.flapjack.io/doc/guides/managing-results/optimize-search-results/handling-natural-languages-nlp/in-depth/language-specific-configurations).
 * @param disablePrefixOnAttributes Searchable attributes for which you want to turn off
 *   [prefix matching](https://www.flapjack.io/doc/guides/managing-results/optimize-search-results/override-search-engine-defaults/#adjusting-prefix-search).
 *   Attribute names are case-sensitive.
 ...
 * @param numericAttributesForFiltering Numeric attributes that can be used as
 *   [numerical filters](https://www.flapjack.io/doc/guides/managing-results/rules/detecting-intent/how-to/applying-a-custom-filter-for-a-specific-query/#numerical-filters).
 ...
 * @param separatorsToIndex Control which non-alphanumeric characters are indexed. By default,
 *   Algolia ignores
 *   [non-alphanumeric characters](https://www.flapjack.io/doc/guides/managing-results/optimize-search-results/typo-tolerance/how-to/how-to-search-in-hyphenated-attributes/#handling-non-alphanumeric-characters)
 ...
 * @param searchableAttributes Attributes used for searching. Attribute names are case-sensitive. By
 *   default, all attributes are searchable and the
 *   [Attribute](https://www.flapjack.io/doc/guides/managing-results/relevance-overview/in-depth/ranking-criteria/#attribute)
 ...
 *   information, see
 *   [Searchable attributes](https://www.flapjack.io/doc/guides/sending-and-managing-data/prepare-your-data/how-to/setting-searchable-attributes).
 ...
 * @param customNormalization Characters and their normalized replacements. This overrides Algolia's
 *   default
 *   [normalization](https://www.flapjack.io/doc/guides/managing-results/optimize-search-results/handling-natural-languages-nlp/in-depth/normalization).
 * @param attributeForDistinct Attribute that should be used to establish groups of results.
 *   Attribute names are case-sensitive. All records with the same value for this attribute are
 *   considered a group. You can combine `attributeForDistinct` with the `distinct` search parameter
 *   to control how many items per group are included in the search results. If you want to use the
 *   same attribute also for faceting, use the `afterDistinct` modifier of the
 *   `attributesForFaceting` setting. This applies faceting _after_ deduplication, which will result
 *   in accurate facet counts.
 * @param maxFacetHits Maximum number of facet values to return when
 *   [searching for facet values](https://www.flapjack.io/doc/guides/managing-results/refine-results/faceting/#search-for-facet-values).
 * @param keepDiacriticsOnCharacters Characters for which diacritics should be preserved. By
 *   default, Algolia removes diacritics from letters. For example, `é` becomes `e`. If this causes
 *   issues in your search, you can specify characters that should keep their diacritics.
 * @param customRanking Attributes to use as
 *   [custom ranking](https://www.flapjack.io/doc/guides/managing-results/must-do/custom-ranking).
 ...
 *   attribute, in descending order. If you use two or more custom ranking attributes,
 *   [reduce the precision](https://www.flapjack.io/doc/guides/managing-results/must-do/custom-ranking/how-to/controlling-custom-ranking-metrics-precision)
 ...
 *   corresponds to a
 *   [ranking criteria](https://www.flapjack.io/doc/guides/managing-results/relevance-overview/in-depth/ranking-criteria).
 ...
 *   [sorting by an attribute](https://www.flapjack.io/doc/guides/managing-results/refine-results/sorting/how-to/sort-by-attribute),
 ...
 *   [A/B testing](https://www.flapjack.io/doc/guides/ab-testing/what-is-ab-testing).
 ...
 *   [virtual replica indices](https://www.flapjack.io/doc/guides/managing-results/refine-results/sorting/in-depth/replicas/#what-are-virtual-replicas).
 ...
 *   information, see
 *   [Highlighting and snippeting](https://www.flapjack.io/doc/guides/building-search-ui/ui-and-ux-patterns/highlighting-snippeting/js).
 * @param attributesToSnippet Attributes for which to enable snippets. Attribute names are
 *   case-sensitive Snippets provide additional context to matched words. If you enable snippets,
 ...
 * @param restrictHighlightAndSnippetArrays Whether to restrict highlighting and snippeting to items
 *   that at least partially matched the search query. By default, all items are highlighted and
 *   snippeted.
 * @param minWordSizefor1Typo Minimum number of characters a word in the search query must contain
 *   to accept matches with
 *   [one typo](https://www.flapjack.io/doc/guides/managing-results/optimize-search-results/typo-tolerance/in-depth/configuring-typo-tolerance/#configuring-word-length-for-typos).
 * @param minWordSizefor2Typos Minimum number of characters a word in the search query must contain
 *   to accept matches with
 *   [two typos](https://www.flapjack.io/doc/guides/managing-results/optimize-search-results/typo-tolerance/in-depth/configuring-typo-tolerance/#configuring-word-length-for-typos).
 * @param typoTolerance
 ...
 *   numbers.
 * @param disableTypoToleranceOnAttributes Attributes for which you want to turn off
 *   [typo tolerance](https://www.flapjack.io/doc/guides/managing-results/optimize-search-results/typo-tolerance).
 *   Attribute names are case-sensitive Returning only exact matches can help when - [Searching in
 *   hyphenated
 *   attributes](https://www.flapjack.io/doc/guides/managing-results/optimize-search-results/typo-tolerance/how-to/how-to-search-in-hyphenated-attributes). -
 ...
 *   [CJK](https://www.flapjack.io/doc/guides/managing-results/optimize-search-results/handling-natural-languages-nlp/in-depth/normalization/#normalization-for-logogram-based-languages-cjk)
 ...
 *   [Word segmentation](https://www.flapjack.io/doc/guides/managing-results/optimize-search-results/handling-natural-languages-nlp/in-depth/language-specific-configurations/#splitting-compound-words).
 ...
 *   [turn off the Exact ranking criterion](https://www.flapjack.io/doc/guides/managing-results/optimize-search-results/override-search-engine-defaults/in-depth/adjust-exact-settings/#turn-off-exact-for-some-attributes).
 ...
 *   synonyms, as
 *   [exact](https://www.flapjack.io/doc/guides/managing-results/relevance-overview/in-depth/ranking-criteria/#exact)
 ...
 *   [synonyms](https://www.flapjack.io/doc/guides/managing-results/optimize-search-results/adding-synonyms/#regular-synonyms)) -
 ...
 *   [Proximity ranking criterion](https://www.flapjack.io/doc/guides/managing-results/relevance-overview/in-depth/ranking-criteria/#proximity)
 ...
 *   `cursor`, `abTestVariantID`, or any property added by setting `getRankingInfo` to true Your
 *   search depends on the `hits` field. If you omit this field, searches won't return any results.
 *   Your UI might also depend on other properties, for example, for pagination. Before restricting
 *   the response size, check the impact on your search experience.
 ...
 *   [facet value display](https://www.flapjack.io/doc/guides/building-search-ui/ui-and-ux-patterns/facet-display/js).
 ...
 *   [Dynamic Re-Ranking](https://www.flapjack.io/doc/guides/algolia-ai/re-ranking) This setting
...
public data class FallbackParams(
   ...
   * conversion events. For more information, see
   * [user token](https://www.flapjack.io/doc/guides/sending-events/concepts/usertoken).
   */
   ...
   * for the specified words.
   */
  @SerialName(value = "disableTypoToleranceOnWords")
  val disableTypoToleranceOnWords: List<String>? = null,

  /**
   * Attributes, for which you want to support
   * [Japanese transliteration](https://www.flapjack.io/doc/guides/managing-results/optimize-search-results/handling-natural-languages-nlp/in-depth/language-specific-configurations/#japanese-transliteration-and-type-ahead).
   * Transliteration supports searching in any of the Japanese writing systems. To support
   * transliteration, you must set the indexing language to Japanese. Attribute names are
   * case-sensitive.
   */
  @SerialName(value = "attributesToTransliterate")
  val attributesToTransliterate: List<String>? = null,
   ...
   * [Language-specific configuration](https://www.flapjack.io/doc/guides/managing-results/optimize-search-results/handling-natural-languages-nlp/in-depth/language-specific-configurations).
   */
  @SerialName(value = "indexLanguages") val indexLanguages: List<SupportedLanguage>? = null,
  ...
  val disablePrefixOnAttributes: List<String>? = null,
   ...
   */
  @SerialName(value = "allowCompressionOfIntegerArray")
  val allowCompressionOfIntegerArray: Boolean? = null,

  /**
   * Numeric attributes that can be used as
   * [numerical filters](https://www.flapjack.io/doc/guides/managing-results/rules/detecting-intent/how-to/applying-a-custom-filter-for-a-specific-query/#numerical-filters).
   * Attribute names are case-sensitive. By default, all numeric attributes are available as
   * numerical filters. For faster indexing, reduce the number of numeric attributes. To turn off
   * filtering for all numeric attributes, specify an attribute that doesn't exist in your index,
   ...
   * filtering based on equality comparisons `=` and `!=`.
   */
  @SerialName(value = "numericAttributesForFiltering")
  val numericAttributesForFiltering: List<String>? = null,
   ...
   * [normalization](https://www.flapjack.io/doc/guides/managing-results/optimize-search-results/handling-natural-languages-nlp/in-depth/normalization).
   */
  @SerialName(value = "customNormalization")
  val customNormalization: Map<kotlin.String, Map<kotlin.String, String>>? = null,
   ...
   * highlight matching parts of a search query in your UI For more information, see
   * [Highlighting and snippeting](https://www.flapjack.io/doc/guides/building-search-ui/ui-and-ux-patterns/highlighting-snippeting/js).
   */
  ...
  /**
   * Attributes for which you want to turn off
   * [typo tolerance](https://www.flapjack.io/doc/guides/managing-results/optimize-search-results/typo-tolerance).
   * Attribute names are case-sensitive Returning only exact matches can help when - [Searching in
   * hyphenated
   * attributes](https://www.flapjack.io/doc/guides/managing-results/optimize-search-results/typo-tolerance/how-to/how-to-search-in-hyphenated-attributes). -
