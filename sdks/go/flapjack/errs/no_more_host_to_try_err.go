...
func (e *NoMoreHostToTryError) Error() string {
	baseErr := "all hosts have been contacted unsuccessfully, it can either be a server or a network error or wrong appID/key credentials were used. If the error persists, please visit our help center https://github.com/flapjackhq/flapjack-search-go/issues or reach out to the Flapjack Support: https://github.com/flapjackhq/flapjack-search-go/issues"
