...
class Hit extends AbstractModel implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    protected static $modelTypes = [
        'objectID' => 'string',
        'highlightResult' => 'array<string,\Flapjack\FlapjackSearch\Model\Composition\HighlightResult>',
        'snippetResult' => 'array<string,\Flapjack\FlapjackSearch\Model\Composition\SnippetResult>',
        'rankingInfo' => '\Flapjack\FlapjackSearch\Model\Composition\HitRankingInfo',
        'distinctSeqID' => 'int',
        'extra' => '\Flapjack\FlapjackSearch\Model\Composition\HitMetadata',
    ];
     ...
     * Sets rankingInfo.
     *
     * @param null|HitRankingInfo $rankingInfo rankingInfo
     *
     * @return self
     */
