/// Core functionality for interacting with the Flapjack API.
///
/// This library provides the essential logic for configuring and executing
/// HTTP requests to the Flapjack API. It includes support for retry strategies
/// and comprehensive exception handling.
library;

export 'src/flapjack_exception.dart';
