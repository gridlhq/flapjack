...
namespace Flapjack\FlapjackSearch\Model\QuerySuggestions;
 ...
 * @category Class
 */
class LogFile extends AbstractModel implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    /**
    ...
    protected static $modelTypes = [
        'timestamp' => 'string',
        'level' => '\Flapjack\FlapjackSearch\Model\QuerySuggestions\LogLevel',
        'message' => 'string',
        'contextLevel' => 'int',
    ];
