...
export function searchClient(
  ...
  return {
    ...
    /**
     * Helper: Copies the given `sourceIndexName` records, rules and synonyms to another Flapjack application for the given `destinationIndexName`.
     * See https://api-clients-automation.netlify.app/docs/custom-helpers/#replaceallobjects for implementation details.
     *
     * @summary Helper: Copies the given `sourceIndexName` records, rules and synonyms to another Flapjack application for the given `destinationIndexName`.
    ...
    async accountCopyIndex(
      ...
      const destinationClient = createSearchClient({
        ...
        flapjackAgents: [{ segment: 'accountCopyIndex', version: process.versions.node }],
        responsesCache: createNullCache(),
        requestsCache: createNullCache(),
        hostsCache: createMemoryCache(),
        ...options,
