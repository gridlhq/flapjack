...
/**
 * SearchRecommendRulesResponse Class Doc Comment.
 *
 * @category Class
 */
class SearchRecommendRulesResponse extends AbstractModel implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    /**
    ...
    protected static $modelTypes = [
        'hits' => '\Flapjack\FlapjackSearch\Model\Recommend\RecommendRule[]',
        'nbHits' => 'int',
        'page' => 'int',
        'nbPages' => 'int',
    ];
