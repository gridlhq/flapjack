...
- ❌ **WRONG**: `origin .../algolia/flapjack-search-javascript.git` → STOP! This is the PUBLIC repository

**If you're in `flapjack-search-javascript`**: Do NOT make changes here. All changes must go through `api-clients-automation`. PRs and commits made directly to the public repo will be discarded on next release.
...
'clients/flapjack-search-javascript/packages/**/package.json',  // Generated
'!clients/flapjack-search-javascript/packages/client-common/**', // Hand-written ✓
```
...
- Run: `yarn cli format javascript clients/flapjack-search-javascript`
...
yarn cli format javascript clients/flapjack-search-javascript

# From client directory (for package-specific work)
cd clients/flapjack-search-javascript
