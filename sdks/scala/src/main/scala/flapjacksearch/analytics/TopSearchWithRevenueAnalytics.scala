...
/** TopSearchWithRevenueAnalytics
  ...
  *   number of tracked searches. If null, Flapjack didn't receive any search requests with `clickAnalytics` set to true.
  * @param averageClickPosition
  *   Average position of a clicked search result in the list of search results. If null, Flapjack didn't receive any
  ...
  *   of tracked searches. If null, Flapjack didn't receive any search requests with `clickAnalytics` set to true.
  * @param purchaseCount
