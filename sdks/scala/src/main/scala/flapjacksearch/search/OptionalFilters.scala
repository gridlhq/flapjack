...
/** Filters to promote or demote records in the search results. Optional filters work like facet filters, but they don't
  ...
  * [ranking](https://www.flapjack.io/doc/guides/managing-results/relevance-overview/in-depth/ranking-criteria)). -
  * Optional filters don't work with numeric attributes. - On virtual replicas, optional filters are applied _after_ the
  * replica's [relevant
  * sort](https://www.flapjack.io/doc/guides/managing-results/refine-results/sorting/in-depth/relevant-sort).
  */
