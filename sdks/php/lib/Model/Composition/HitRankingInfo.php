...
/**
 * HitRankingInfo Class Doc Comment.
 *
 * @category Class
 */
class HitRankingInfo extends AbstractModel implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    /**
    ...
    protected static $modelTypes = [
        ...
        'geoDistance' => 'int',
        'geoPrecision' => 'int',
        'matchedGeoLocation' => '\Flapjack\FlapjackSearch\Model\Composition\MatchedGeoLocation',
        'personalization' => '\Flapjack\FlapjackSearch\Model\Composition\Personalization',
        'nbExactWords' => 'int',
        'nbTypos' => 'int',
        'promoted' => 'bool',
        ...
        'composed' => 'array<string,\Flapjack\FlapjackSearch\Model\Composition\CompositionIdRankingInfo>',
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        if (isset($data['composed'])) {
            $this->container['composed'] = $data['composed'];
        }
    }
    ...
    {
        return $this->container['composed'] ?? null;
    }
