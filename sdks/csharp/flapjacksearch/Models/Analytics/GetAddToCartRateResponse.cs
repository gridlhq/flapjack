...
public partial class GetAddToCartRateResponse
{
  ...
  /// Initializes a new instance of the GetAddToCartRateResponse class.
  /// </summary>
  /// <param name="rate">Add-to-cart rate: calculated as the number of tracked searches with at least one add-to-cart event divided by the number of tracked searches. If null, Flapjack didn't receive any search requests with `clickAnalytics` set to true.  (required).</param>
