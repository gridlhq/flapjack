...
public partial class SourceUpdateCommercetools
{
  ...
  /// <summary>
  /// Whether a fallback value is stored in the Flapjack record if there's no inventory information about the product.
  /// </summary>
  /// <value>Whether a fallback value is stored in the Flapjack record if there's no inventory information about the product. </value>
