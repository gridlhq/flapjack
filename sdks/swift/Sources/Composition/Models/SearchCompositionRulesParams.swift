...
public struct SearchCompositionRulesParams: Codable, JSONEncodable {
    ...
    /// If `true`, return only enabled composition rules. If `false`, return only inactive composition rules. By
    /// default, _all_ composition rules are returned.
