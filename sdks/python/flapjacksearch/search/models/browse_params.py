...
from flapjacksearch.search.models.browse_params_object import BrowseParamsObject
...
class BrowseParams(BaseModel):
    ...
    def unwrap_actual_instance(
        self,
    ) -> Union[BrowseParamsObject, SearchParamsString, Self, None]:
        """
    ...
    def from_dict(cls, obj: Union[str, Dict[str, Any]]) -> Self:
        """Create an instance of BrowseParams from a JSON string"""
    ...
    def to_dict(
        self,
    ) -> Optional[Union[Dict[str, Any], BrowseParamsObject, SearchParamsString]]:
