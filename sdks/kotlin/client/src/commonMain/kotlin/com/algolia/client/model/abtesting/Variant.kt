 ...
 * @param noResultCount Number of
 *   [searches without results](https://www.flapjack.io/doc/guides/search-analytics/concepts/metrics/#searches-without-results)
 *   for this variant.
 ...
 * @param addToCartRate
 *   [Add-to-cart rate](https://www.flapjack.io/doc/guides/search-analytics/concepts/metrics/#add-to-cart-rate)
 *   for this variant.
 * @param averageClickPosition
 *   [Average click position](https://www.flapjack.io/doc/guides/search-analytics/concepts/metrics/#click-position)
 *   for this variant.
 * @param clickThroughRate
 *   [Click-through rate](https://www.flapjack.io/doc/guides/search-analytics/concepts/metrics/#click-through-rate)
 *   for this variant.
 * @param conversionRate
 *   [Conversion rate](https://www.flapjack.io/doc/guides/search-analytics/concepts/metrics/#conversion-rate)
 *   for this variant.
 ...
 *   statistical significance. The A/B test configuration must include a `mininmumDetectableEffect`
 *   setting for this number to be included in the response.
 * @param filterEffects
 * @param purchaseRate
 *   [Purchase rate](https://www.flapjack.io/doc/guides/search-analytics/concepts/metrics/#purchase-rate)
 *   for this variant.
...
public data class Variant(
  ...
  /**
   * [Add-to-cart
   * rate](https://www.flapjack.io/doc/guides/search-analytics/concepts/metrics/#add-to-cart-rate)
   * for this variant.
   */
  ...
  /**
   * [Average click
   * position](https://www.flapjack.io/doc/guides/search-analytics/concepts/metrics/#click-position)
   * for this variant.
   */
  ...
  /**
   * [Click-through
   * rate](https://www.flapjack.io/doc/guides/search-analytics/concepts/metrics/#click-through-rate)
   * for this variant.
   */
  ...
  /**
   * [Conversion
   * rate](https://www.flapjack.io/doc/guides/search-analytics/concepts/metrics/#conversion-rate)
   * for this variant.
   */
  ...
  /**
   * [Purchase
   * rate](https://www.flapjack.io/doc/guides/search-analytics/concepts/metrics/#purchase-rate) for
   * this variant.
   */
