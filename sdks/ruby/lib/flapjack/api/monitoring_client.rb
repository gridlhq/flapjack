...
module Flapjack
  class MonitoringClient
    ...
    def self.create(app_id, api_key, opts = {})
      hosts = []
      hosts << Transport::StatefulHost.new("status.flapjack.io", accept: CallType::READ | CallType::WRITE)

      config = Flapjack::Configuration.new(app_id, api_key, hosts, "Monitoring", opts)
      new(config)
    end
