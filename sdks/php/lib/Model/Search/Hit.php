...
class Hit extends AbstractModel implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    protected static $modelTypes = [
        'objectID' => 'string',
        'highlightResult' => 'array<string,\Flapjack\FlapjackSearch\Model\Search\HighlightResult>',
        'snippetResult' => 'array<string,\Flapjack\FlapjackSearch\Model\Search\SnippetResult>',
        'rankingInfo' => '\Flapjack\FlapjackSearch\Model\Search\RankingInfo',
        'distinctSeqID' => 'int',
    ];
