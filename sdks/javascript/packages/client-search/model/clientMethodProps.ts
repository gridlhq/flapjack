...
import type { CreateIterablePromise } from '@flapjack-search/client-common';
...
/**
 * Search method signature compatible with the `flapjack-search` v4 package. When using this signature, extra computation will be required to make it match the new signature.
 *
...
export type ReplaceAllObjectsOptions = {
  ...
  /**
   * The array of `objects` to store in the given Flapjack `indexName`.
   */
