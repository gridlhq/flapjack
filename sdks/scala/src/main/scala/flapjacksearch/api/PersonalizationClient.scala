...
import flapjacksearch.personalization.DeleteUserProfileResponse
import flapjacksearch.personalization.ErrorBase
import flapjacksearch.personalization.GetUserTokenResponse
import flapjacksearch.personalization.PersonalizationStrategyParams
import flapjacksearch.personalization.SetPersonalizationStrategyResponse
import flapjacksearch.personalization._
import flapjacksearch.ApiClient
import flapjacksearch.api.PersonalizationClient.hosts
import flapjacksearch.api.PersonalizationClient.readTimeout
import flapjacksearch.api.PersonalizationClient.writeTimeout
import flapjacksearch.api.PersonalizationClient.connectTimeout
...
object PersonalizationClient {
  ...
  private def hosts(region: String): Seq[Host] = {
    ...
    val url = "personalization.{region}.flapjack.io".replace("{region}", region)
