...
public sealed interface AroundRadius {
  @Serializable @JvmInline public value class IntValue(public val value: Int) : AroundRadius
...
internal class AroundRadiusSerializer :
  JsonContentPolymorphicSerializer<AroundRadius>(AroundRadius::class) {
