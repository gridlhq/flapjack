...
public struct SearchForFacets: Codable, JSONEncodable {
...
extension SearchForFacets: Equatable {
    public static func ==(lhs: SearchForFacets, rhs: SearchForFacets) -> Bool {
...
extension SearchForFacets: Hashable {
