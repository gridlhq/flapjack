...
/** Variant
  ...
  *   must include a `minimumDetectableEffect` setting for this number to be included in the response.
  * @param index
...
case class Variant(
    ...
    metadata: Option[VariantMetadata] = scala.None,
    customSearchParameters: Option[Any] = scala.None
)
