...
public partial class Params
{
  ...
  /// <summary>
  /// Assigns a rule context to the run query [Rule contexts](https://www.flapjack.io/doc/guides/managing-results/rules/rules-overview/how-to/customize-search-results-by-platform/#whats-a-context) are strings that you can use to trigger matching rules.
  /// </summary>
  /// <value>Assigns a rule context to the run query [Rule contexts](https://www.flapjack.io/doc/guides/managing-results/rules/rules-overview/how-to/customize-search-results-by-platform/#whats-a-context) are strings that you can use to trigger matching rules. </value>
