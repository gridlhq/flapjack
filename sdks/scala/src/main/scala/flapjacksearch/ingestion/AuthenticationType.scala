...
object AuthenticationType {
  ...
  case object Flapjack extends AuthenticationType {
    override def toString = "algolia"
  }
  case object FlapjackInsights extends AuthenticationType {
  ...
  val values: Seq[AuthenticationType] =
    Seq(GoogleServiceAccount, Basic, ApiKey, Oauth, Flapjack, FlapjackInsights, Secrets)
