...
[assembly: InternalsVisibleTo("Flapjack.Search.Tests")]
[assembly: InternalsVisibleTo("Flapjack.Search.IntegrationTests")]
...
internal class RetryStrategy
{
  ...
  public RetryStrategy(FlapjackConfig config)
  {
  ...
  /// <param name="response">Flapjack's API response</param>
  /// <returns></returns>
  public RetryOutcomeType Decide(StatefulHost tryableHost, FlapjackHttpResponse response)
  {
    lock (_lock)
    {
  ...
  /// <param name="response">Flapjack's API response</param>
  /// <returns></returns>
  private static bool IsSuccess(FlapjackHttpResponse response)
  {
  ...
  /// <param name="response">Flapjack's API response</param>
  /// <returns></returns>
  private static bool IsRetryable(FlapjackHttpResponse response)
  {
