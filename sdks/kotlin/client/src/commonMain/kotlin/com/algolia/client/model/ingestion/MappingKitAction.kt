 ...
 * @param trigger Condition which must be satisfied to apply the action. If this evaluates to false,
 *   the action is not applied, and the process attempts to apply the next action, if any.
