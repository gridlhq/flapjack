...
/**
 * TaskCreateV1 Class Doc Comment.
 *
 * @category Class
 *
 * @description API request body for creating a task using the V1 shape. Use methods and types that don't contain the V1 suffix.
 */
class TaskCreateV1 extends AbstractModel implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    protected static $modelTypes = [
        ...
        'trigger' => '\Flapjack\FlapjackSearch\Model\Ingestion\TaskCreateTrigger',
        'action' => '\Flapjack\FlapjackSearch\Model\Ingestion\ActionType',
        'enabled' => 'bool',
        'failureThreshold' => 'int',
        'input' => '\Flapjack\FlapjackSearch\Model\Ingestion\TaskInput',
        'cursor' => 'string',
    ];
