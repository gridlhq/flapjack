...
public sealed interface TaskCreateTrigger {
  @Serializable
  @JvmInline
  public value class ScheduleTriggerInputValue(public val value: ScheduleTriggerInput) :
    TaskCreateTrigger

  @Serializable
  @JvmInline
  public value class OnDemandTriggerInputValue(public val value: OnDemandTriggerInput) :
    TaskCreateTrigger

  @Serializable
  @JvmInline
  public value class SubscriptionTriggerValue(public val value: SubscriptionTrigger) :
    TaskCreateTrigger
...
internal class TaskCreateTriggerSerializer :
  JsonContentPolymorphicSerializer<TaskCreateTrigger>(TaskCreateTrigger::class) {
  override fun selectDeserializer(
    element: JsonElement
  ): DeserializationStrategy<TaskCreateTrigger> {
    return when {
