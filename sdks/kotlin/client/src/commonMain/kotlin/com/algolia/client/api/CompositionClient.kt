...
import com.flapjackhq.client.model.composition.*
import com.flapjackhq.client.model.composition.RequestBody
...
public class CompositionClient(
   ...
   * [`search` operation](https://www.flapjack.io/doc/rest-api/composition/search-composition-rules).
   *
   * Required API Key ACLs:
   * - editSettings
   * - settings
