...
from flapjacksearch.composition.models.typo_tolerance_enum import TypoToleranceEnum
...
class TypoTolerance(BaseModel):
    ...
    def from_dict(cls, obj: Union[str, Dict[str, Any]]) -> Self:
        """Create an instance of TypoTolerance from a JSON string"""
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], TypoToleranceEnum, bool]]:
