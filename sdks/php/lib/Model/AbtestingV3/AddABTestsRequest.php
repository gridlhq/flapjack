...
class AddABTestsRequest extends AbstractModel implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    protected static $modelTypes = [
        'name' => 'string',
        'variants' => '\Flapjack\FlapjackSearch\Model\AbtestingV3\AddABTestsVariant[]',
        'metrics' => '\Flapjack\FlapjackSearch\Model\AbtestingV3\CreateMetric[]',
        'configuration' => '\Flapjack\FlapjackSearch\Model\AbtestingV3\ABTestConfiguration',
        'endAt' => 'string',
    ];
