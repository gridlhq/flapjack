...
class Params extends AbstractModel implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    protected static $modelTypes = [
        ...
        'aroundRadius' => '\Flapjack\FlapjackSearch\Model\Composition\AroundRadius',
        'aroundPrecision' => '\Flapjack\FlapjackSearch\Model\Composition\AroundPrecision',
        'clickAnalytics' => 'bool',
        'enableABTest' => 'bool',
        ...
        'getRankingInfo' => 'bool',
        'hitsPerPage' => 'int',
        'injectedItems' => 'array<string,\Flapjack\FlapjackSearch\Model\Composition\ExternalInjectedItem>',
        'insideBoundingBox' => '\Flapjack\FlapjackSearch\Model\Composition\InsideBoundingBox',
        'insidePolygon' => 'float[][]',
