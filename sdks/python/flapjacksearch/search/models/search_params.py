...
from flapjacksearch.search.models.search_params_object import SearchParamsObject
from flapjacksearch.search.models.search_params_string import SearchParamsString
...
class SearchParams(BaseModel):
    ...
    oneof_schema_2_validator: Optional[SearchParamsObject] = Field(default=None)

    actual_instance: Union[SearchParamsObject, SearchParamsString, None] = None
    one_of_schemas: Set[str] = {"SearchParamsObject", "SearchParamsString"}
    ...
    def unwrap_actual_instance(
        self,
    ) -> Union[SearchParamsObject, SearchParamsString, Self, None]:
        """
