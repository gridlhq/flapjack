...
public partial class DailyClickThroughRates
{
  ...
  /// Initializes a new instance of the DailyClickThroughRates class.
  /// </summary>
  /// <param name="rate">Click-through rate: calculated as the number of tracked searches with at least one click event divided by the number of tracked searches. If null, Flapjack didn't receive any search requests with `clickAnalytics` set to true.  (required).</param>
