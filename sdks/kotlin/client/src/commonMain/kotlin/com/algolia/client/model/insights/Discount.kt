...
public sealed interface Discount {
  @Serializable @JvmInline public value class DoubleValue(public val value: Double) : Discount

  @Serializable @JvmInline public value class StringValue(public val value: String) : Discount
