...
import flapjacksearch.insights.ErrorBase
import flapjacksearch.insights.EventsResponse
import flapjacksearch.insights.InsightsEvents
import flapjacksearch.insights._
import flapjacksearch.ApiClient
import flapjacksearch.api.InsightsClient.hosts
import flapjacksearch.api.InsightsClient.readTimeout
import flapjacksearch.api.InsightsClient.writeTimeout
import flapjacksearch.api.InsightsClient.connectTimeout
...
object InsightsClient {
  ...
  private def hosts(region: Option[String] = None): Seq[Host] = {
    ...
    val url =
      if (region.isEmpty) "insights.flapjack.io" else "insights.{region}.flapjack.io".replace("{region}", region.get)
