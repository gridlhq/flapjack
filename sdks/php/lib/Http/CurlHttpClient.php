...
namespace Flapjack\FlapjackSearch\Http;
...
final class CurlHttpClient implements HttpClientInterface
{
    ...
    {
        throw new \OutOfBoundsException(sprintf('FlapjackSearch curloptions options keys are invalid. %s given. error message : %s', json_encode($curlOptions), $errorMsg));
    }
}
