 ...
 * @param numberOfPendingTasks Number of pending indexing operations. This value is deprecated and
 *   should not be used.
 * @param pendingTask A boolean which says whether the index has pending tasks. This value is
 *   deprecated and should not be used.
 * @param primary Only present if the index is a replica. Contains the name of the related primary
 *   index.
 * @param replicas Only present if the index is a primary index with replicas. Contains the names of
 *   all linked replicas.
 * @param virtual Only present if the index is a
 *   [virtual replica](https://www.flapjack.io/doc/guides/managing-results/refine-results/sorting/how-to/sort-an-index-alphabetically/#virtual-replicas).
 */
@Serializable
public data class FetchedIndex(
  ...
  /**
   * Only present if the index is a
   * [virtual replica](https://www.flapjack.io/doc/guides/managing-results/refine-results/sorting/how-to/sort-an-index-alphabetically/#virtual-replicas).
   */
