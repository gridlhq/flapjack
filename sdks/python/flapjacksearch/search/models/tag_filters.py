...
class TagFilters(BaseModel):
    ...
    oneof_schema_1_validator: Optional[List[TagFilters]] = Field(default=None)

    oneof_schema_2_validator: Optional[str] = Field(default=None)

    actual_instance: Union[List[TagFilters], str, None] = None
    one_of_schemas: Set[str] = {"List[TagFilters]", "str"}
    ...
    @model_serializer
    def unwrap_actual_instance(self) -> Union[List[TagFilters], str, Self, None]:
        """
    ...
    def from_dict(cls, obj: Union[str, Dict[str, Any]]) -> Self:
        """Create an instance of TagFilters from a JSON string"""
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        raise ValueError(
            "No match found when deserializing the JSON string into TagFilters with oneOf schemas: List[TagFilters], str. Details: "
            + ", ".join(error_messages)
        )
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], List[TagFilters], str]]:
