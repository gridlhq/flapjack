...
public sealed interface AuthInputPartial {
  @Serializable
  @JvmInline
  public value class AuthGoogleServiceAccountPartialValue(
    public val value: AuthGoogleServiceAccountPartial
  ) : AuthInputPartial
  ...
  @Serializable
  @JvmInline
  public value class AuthAlgoliaPartialValue(public val value: AuthAlgoliaPartial) :
    AuthInputPartial

  @Serializable
  @JvmInline
  public value class AuthAlgoliaInsightsPartialValue(public val value: AuthAlgoliaInsightsPartial) :
    AuthInputPartial
  ...
  public companion object {
    ...
    public fun of(value: AuthGoogleServiceAccountPartial): AuthInputPartial =
      AuthGoogleServiceAccountPartialValue(value)
    ...
    public fun of(value: AuthAlgoliaInsightsPartial): AuthInputPartial =
      AuthAlgoliaInsightsPartialValue(value)
...
internal class AuthInputPartialSerializer :
  JsonContentPolymorphicSerializer<AuthInputPartial>(AuthInputPartial::class) {
  override fun selectDeserializer(element: JsonElement): DeserializationStrategy<AuthInputPartial> {
    return when {
      element is JsonObject && element.containsKey("clientEmail") ->
        AuthGoogleServiceAccountPartial.serializer()
