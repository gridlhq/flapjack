...
from flapjacksearch.search.models.search_for_facet_values_response import (
    SearchForFacetValuesResponse,
)
from flapjacksearch.search.models.search_response import SearchResponse
...
class SearchResult(BaseModel):
    ...
    oneof_schema_1_validator: Optional[SearchResponse] = Field(default=None)

    oneof_schema_2_validator: Optional[SearchForFacetValuesResponse] = Field(
        default=None
    )
