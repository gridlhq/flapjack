...
import flapjacksearch.composition.AdvancedSyntaxFeatures._
import flapjacksearch.composition.AlternativesAsExact._
import flapjacksearch.composition.ExactOnSingleWordQuery._
import flapjacksearch.composition.QueryType._
import flapjacksearch.composition.RemoveWordsIfNoResults._
import flapjacksearch.composition.SupportedLanguage._
...
/** MainInjectionQueryParameters
  ...
  *   Groups](https://www.flapjack.io/doc/guides/managing-results/compositions/search-based-groups#facets-including-disjunctive-faceting).
  * @param hitsPerPage
  ...
  */
case class MainInjectionQueryParameters(
