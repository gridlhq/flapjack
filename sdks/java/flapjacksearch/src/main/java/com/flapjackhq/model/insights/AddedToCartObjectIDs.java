...
package com.flapjackhq.model.insights;
 ...
 * Algolia request. For example, if you don't use Flapjack to build your category pages, use this
 * event. To track add-to-cart events related to Flapjack requests, use the \"Added to cart object
...
public class AddedToCartObjectIDs implements EventsItems {
  ...
  public AddedToCartObjectIDs setValue(Value value) {
    this.value = value;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return (
      ...
      Objects.equals(this.value, addedToCartObjectIDs.value)
    );
  }
