...
public struct BrowseParamsObject: Codable, JSONEncodable {
    /// Search query.
...
extension BrowseParamsObject: Equatable {
    public static func ==(lhs: BrowseParamsObject, rhs: BrowseParamsObject) -> Bool {
        lhs.query == rhs.query &&
...
extension BrowseParamsObject: Hashable {
