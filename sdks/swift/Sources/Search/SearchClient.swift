...
open class SearchClient {
    ...
    open func addOrUpdateObjectWithHTTPInfo(
        ...
        guard !indexName.isEmpty else {
            throw FlapjackError.invalidArgument("indexName", "addOrUpdateObject")
        }

        guard !objectID.isEmpty else {
            throw FlapjackError.invalidArgument("objectID", "addOrUpdateObject")
        }
    ...
    // limits](https://support.flapjack.io/hc/articles/4406975251089-Is-there-a-rate-limit-for-indexing-on-Algolia).
    // Required API Key ACLs:
    //  - addObject
    //
    // - parameter indexName: (path) Name of the index on which to perform the operation.
    ...
    open func batchWithHTTPInfo(
        ...
        guard !indexName.isEmpty else {
            throw FlapjackError.invalidArgument("indexName", "batch")
        }
    ...
    // The Analytics API doesn't collect data when using `browse`. - Records are ranked by attributes and custom
    // ranking.
    ...
    // `attributesToSnippet`: `[]` - `distinct`: `false` - `enablePersonalization`: `false` - `enableRules`: `false` - `facets`: `[]` - `getRankingInfo`: `false` - `ignorePlurals`: `false` - `optionalFilters`: `[]` - `typoTolerance`: `true` or `false` (`min` and `strict` evaluate to `true`)  If you send these parameters with your browse requests, they're ignored.
    // Required API Key ACLs:
    //  - browse
    //
    // - parameter indexName: (path) Name of the index on which to perform the operation.
    ...
    open func browseWithHTTPInfo<T: Codable>(
        ...
        guard !indexName.isEmpty else {
            throw FlapjackError.invalidArgument("indexName", "browse")
        }
    ...
    open func clearObjectsWithHTTPInfo(
        ...
        guard !indexName.isEmpty else {
            throw FlapjackError.invalidArgument("indexName", "clearObjects")
        }
    ...
    open func clearRulesWithHTTPInfo(
        ...
        guard !indexName.isEmpty else {
            throw FlapjackError.invalidArgument("indexName", "clearRules")
        }
    ...
    open func clearSynonymsWithHTTPInfo(
        ...
        guard !indexName.isEmpty else {
            throw FlapjackError.invalidArgument("indexName", "clearSynonyms")
        }
    ...
    open func customDeleteWithHTTPInfo(
        ...
        guard !path.isEmpty else {
            throw FlapjackError.invalidArgument("path", "customDelete")
        }
    ...
    open func customGetWithHTTPInfo(
        ...
        guard !path.isEmpty else {
            throw FlapjackError.invalidArgument("path", "customGet")
        }
    ...
    open func customPostWithHTTPInfo(
        ...
        guard !path.isEmpty else {
            throw FlapjackError.invalidArgument("path", "customPost")
        }
    ...
    open func customPutWithHTTPInfo(
        ...
        guard !path.isEmpty else {
            throw FlapjackError.invalidArgument("path", "customPut")
        }
    ...
    open func deleteApiKeyWithHTTPInfo(
        ...
        guard !key.isEmpty else {
            throw FlapjackError.invalidArgument("key", "deleteApiKey")
        }
    ...
    open func deleteByWithHTTPInfo(
        ...
        guard !indexName.isEmpty else {
            throw FlapjackError.invalidArgument("indexName", "deleteBy")
        }
    ...
    open func deleteIndexWithHTTPInfo(
        ...
        guard !indexName.isEmpty else {
            throw FlapjackError.invalidArgument("indexName", "deleteIndex")
        }
    ...
    open func deleteObjectWithHTTPInfo(
        ...
        guard !indexName.isEmpty else {
            throw FlapjackError.invalidArgument("indexName", "deleteObject")
        }

        guard !objectID.isEmpty else {
            throw FlapjackError.invalidArgument("objectID", "deleteObject")
        }
    ...
    open func deleteRuleWithHTTPInfo(
        ...
        guard !indexName.isEmpty else {
            throw FlapjackError.invalidArgument("indexName", "deleteRule")
        }

        guard !objectID.isEmpty else {
            throw FlapjackError.invalidArgument("objectID", "deleteRule")
        }
    ...
    open func deleteSourceWithHTTPInfo(
        ...
        guard !source.isEmpty else {
            throw FlapjackError.invalidArgument("source", "deleteSource")
        }
    ...
    open func deleteSynonymWithHTTPInfo(
        ...
        guard !indexName.isEmpty else {
            throw FlapjackError.invalidArgument("indexName", "deleteSynonym")
        }

        guard !objectID.isEmpty else {
            throw FlapjackError.invalidArgument("objectID", "deleteSynonym")
        }
    ...
    open func getApiKeyWithHTTPInfo(
        ...
        guard !key.isEmpty else {
            throw FlapjackError.invalidArgument("key", "getApiKey")
        }
    ...
    // ACL](https://www.flapjack.io/doc/guides/security/api-keys/#access-control-list-acl).  - Logs are held for the
    // last
    // seven days. - Up to 1,000 API requests per server are logged. - This request counts towards your [operations
    // quota](https://support.flapjack.io/hc/articles/17245378392977-How-does-Algolia-count-records-and-operations) but
    ...
    open func getObjectWithHTTPInfo(
        ...
        guard !indexName.isEmpty else {
            throw FlapjackError.invalidArgument("indexName", "getObject")
        }

        guard !objectID.isEmpty else {
            throw FlapjackError.invalidArgument("objectID", "getObject")
        }
    ...
    open func getRuleWithHTTPInfo(
        ...
        guard !indexName.isEmpty else {
            throw FlapjackError.invalidArgument("indexName", "getRule")
        }

        guard !objectID.isEmpty else {
            throw FlapjackError.invalidArgument("objectID", "getRule")
        }
    ...
    open func getSettingsWithHTTPInfo(
        ...
        guard !indexName.isEmpty else {
            throw FlapjackError.invalidArgument("indexName", "getSettings")
        }
    ...
    open func getSynonymWithHTTPInfo(
        ...
        guard !indexName.isEmpty else {
            throw FlapjackError.invalidArgument("indexName", "getSynonym")
        }

        guard !objectID.isEmpty else {
            throw FlapjackError.invalidArgument("objectID", "getSynonym")
        }
    ...
    open func getTaskWithHTTPInfo(
        ...
        guard !indexName.isEmpty else {
            throw FlapjackError.invalidArgument("indexName", "getTask")
        }
    ...
    open func getUserIdWithHTTPInfo(
        ...
        guard !userID.isEmpty else {
            throw FlapjackError.invalidArgument("userID", "getUserId")
        }
    ...
    // Copies or moves (renames) an index within the same Algolia application.  Notes: - Existing destination indices
    // are overwritten, except for their analytics data. - If the destination index doesn't exist yet, it's created. -
    // This operation is resource-intensive.  **Copy**  - If the source index doesn't exist, copying creates a new index
    // with 0 records and default settings. - API keys from the source index are merged with the existing keys in the
    ...
    // limits](https://www.flapjack.io/doc/guides/scaling/algolia-service-limits/#application-record-and-index-limits).
    // -
    // For more information, see [Copy indices](https://www.flapjack.io/doc/guides/sending-and-managing-data/manage-indices-and-apps/manage-indices/how-to/copy-indices).
    ...
    // index has replicas, moving will overwrite the existing index and copy the data to the replica indices. - For more
    // information, see [Move indices](https://www.flapjack.io/doc/guides/sending-and-managing-data/manage-indices-and-apps/manage-indices/how-to/move-indices).
    ...
    open func operationIndexWithHTTPInfo(
        ...
        guard !indexName.isEmpty else {
            throw FlapjackError.invalidArgument("indexName", "operationIndex")
        }
    ...
    // append a number or string element to an array attribute. - `Remove`: remove all matching number or string
    // elements
    ...
    open func partialUpdateObjectWithHTTPInfo(
        ...
        guard !indexName.isEmpty else {
            throw FlapjackError.invalidArgument("indexName", "partialUpdateObject")
        }

        guard !objectID.isEmpty else {
            throw FlapjackError.invalidArgument("objectID", "partialUpdateObject")
        }
    ...
    open func removeUserIdWithHTTPInfo(
        ...
        guard !userID.isEmpty else {
            throw FlapjackError.invalidArgument("userID", "removeUserId")
        }
    ...
    open func restoreApiKeyWithHTTPInfo(
        ...
        guard !key.isEmpty else {
            throw FlapjackError.invalidArgument("key", "restoreApiKey")
        }
    ...
    open func saveObjectWithHTTPInfo(
        ...
        guard !indexName.isEmpty else {
            throw FlapjackError.invalidArgument("indexName", "saveObject")
        }
    ...
    open func saveRuleWithHTTPInfo(
        ...
        guard !indexName.isEmpty else {
            throw FlapjackError.invalidArgument("indexName", "saveRule")
        }

        guard !objectID.isEmpty else {
            throw FlapjackError.invalidArgument("objectID", "saveRule")
        }
    ...
    open func saveRulesWithHTTPInfo(
        ...
        guard !indexName.isEmpty else {
            throw FlapjackError.invalidArgument("indexName", "saveRules")
        }
    ...
    open func saveSynonymWithHTTPInfo(
        ...
        guard !indexName.isEmpty else {
            throw FlapjackError.invalidArgument("indexName", "saveSynonym")
        }

        guard !objectID.isEmpty else {
            throw FlapjackError.invalidArgument("objectID", "saveSynonym")
        }
    ...
    open func saveSynonymsWithHTTPInfo(
        ...
        guard !indexName.isEmpty else {
            throw FlapjackError.invalidArgument("indexName", "saveSynonyms")
        }
    ...
    open func searchForFacetValuesWithHTTPInfo(
        ...
        guard !indexName.isEmpty else {
            throw FlapjackError.invalidArgument("indexName", "searchForFacetValues")
        }

        guard !facetName.isEmpty else {
            throw FlapjackError.invalidArgument("facetName", "searchForFacetValues")
        }
    ...
    open func searchRulesWithHTTPInfo(
        ...
        guard !indexName.isEmpty else {
            throw FlapjackError.invalidArgument("indexName", "searchRules")
        }
    ...
    open func searchSingleIndexWithHTTPInfo<T: Codable>(
        ...
        guard !indexName.isEmpty else {
            throw FlapjackError.invalidArgument("indexName", "searchSingleIndex")
        }
    ...
    open func searchSynonymsWithHTTPInfo(
        ...
        guard !indexName.isEmpty else {
            throw FlapjackError.invalidArgument("indexName", "searchSynonyms")
        }
    ...
    open func setSettingsWithHTTPInfo(
        ...
        guard !indexName.isEmpty else {
            throw FlapjackError.invalidArgument("indexName", "setSettings")
        }
    ...
    open func updateApiKeyWithHTTPInfo(
        ...
        guard !key.isEmpty else {
            throw FlapjackError.invalidArgument("key", "updateApiKey")
        }
