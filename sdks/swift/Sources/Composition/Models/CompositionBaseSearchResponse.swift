...
public struct CompositionBaseSearchResponse: Codable, JSONEncodable {
    ...
    public var exhaustive: CompositionExhaustive?
    ...
    public var facetsStats: [String: CompositionFacetStats]?
    ...
    public var redirect: CompositionRedirect?
    ...
    public init(
        ...
        exhaustive: CompositionExhaustive? = nil,
        ...
        facetsStats: [String: CompositionFacetStats]? = nil,
        index: String? = nil,
    ...
    public init(from dictionary: [String: AnyCodable]) throws {
        ...
        self.exhaustive = dictionary["exhaustive"]?.value as? CompositionExhaustive
        ...
        self.facetsStats = dictionary["facetsStats"]?.value as? [String: CompositionFacetStats]
        ...
        self.redirect = dictionary["redirect"]?.value as? CompositionRedirect

        self.renderingContent = dictionary["renderingContent"]?.value as? CompositionRenderingContent
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.exhaustive = try container.decodeIfPresent(CompositionExhaustive.self, forKey: .exhaustive)
        ...
        self.facetsStats = try container.decodeIfPresent([String: CompositionFacetStats].self, forKey: .facetsStats)
        ...
        self.renderingContent = try container.decodeIfPresent(
            CompositionRenderingContent.self,
            forKey: .renderingContent
        )
...
extension CompositionBaseSearchResponse: Equatable {
    public static func ==(lhs: CompositionBaseSearchResponse, rhs: CompositionBaseSearchResponse) -> Bool {
...
extension CompositionBaseSearchResponse: Hashable {
