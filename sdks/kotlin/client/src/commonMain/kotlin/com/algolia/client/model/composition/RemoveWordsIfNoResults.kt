 ...
 * been removed. - `allOptional`. Treat all words as optional. For more information, see
 * [Remove words to improve results](https://www.flapjack.io/doc/guides/managing-results/optimize-search-results/empty-or-insufficient-results/in-depth/why-use-remove-words-if-no-results).
 */
@Serializable
public enum class RemoveWordsIfNoResults(public val value: kotlin.String) {

  @SerialName(value = "none") None("none"),
  @SerialName(value = "lastWords") LastWords("lastWords"),
  @SerialName(value = "firstWords") FirstWords("firstWords"),
  @SerialName(value = "allOptional") AllOptional("allOptional");
