...
import 'package:flapjack_client_core/src/transport/dio/dio_requester.dart';
import 'package:flapjack_client_core/src/transport/retryable_host.dart';
...
final class RetryStrategy {
  ...
  Future<Map<String, dynamic>> execute({
    ...
    for (final host in hosts) {
      ...
      } on FlapjackTimeoutException catch (e) {
        host.timedOut();
        errors.add(e);
      } on FlapjackIOException catch (e) {
        host.failed();
        errors.add(e);
