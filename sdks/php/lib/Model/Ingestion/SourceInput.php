...
class SourceInput extends AbstractModel implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    protected static $modelTypes = [
        ...
        'customFields' => 'string[]',
        'storeHash' => 'string',
        'channel' => '\Flapjack\FlapjackSearch\Model\Ingestion\BigCommerceChannel',
        'productMetafields' => '\Flapjack\FlapjackSearch\Model\Ingestion\BigCommerceMetafield[]',
        'variantMetafields' => '\Flapjack\FlapjackSearch\Model\Ingestion\BigCommerceMetafield[]',
        'uniqueIDColumn' => 'string',
        'method' => '\Flapjack\FlapjackSearch\Model\Ingestion\MethodType',
        'mapping' => 'array<string,\Flapjack\FlapjackSearch\Model\Ingestion\MappingTypeCSV>',
        'delimiter' => 'string',
        'projectID' => 'string',
        'datasetID' => 'string',
        'dataType' => '\Flapjack\FlapjackSearch\Model\Ingestion\BigQueryDataType',
        'table' => 'string',
        'tablePrefix' => 'string',
