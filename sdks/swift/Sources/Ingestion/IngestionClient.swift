...
open class IngestionClient {
    ...
    open func deleteAuthenticationWithHTTPInfo(
        ...
        guard !authenticationID.isEmpty else {
            throw FlapjackError.invalidArgument("authenticationID", "deleteAuthentication")
        }
    ...
    open func deleteDestinationWithHTTPInfo(
        ...
        guard !destinationID.isEmpty else {
            throw FlapjackError.invalidArgument("destinationID", "deleteDestination")
        }
    ...
    open func deleteSourceWithHTTPInfo(
        ...
        guard !sourceID.isEmpty else {
            throw FlapjackError.invalidArgument("sourceID", "deleteSource")
        }
    ...
    open func deleteTaskWithHTTPInfo(
        ...
        guard !taskID.isEmpty else {
            throw FlapjackError.invalidArgument("taskID", "deleteTask")
        }
    ...
    open func deleteTaskV1WithHTTPInfo(
        ...
        guard !taskID.isEmpty else {
            throw FlapjackError.invalidArgument("taskID", "deleteTaskV1")
        }
    ...
    open func deleteTransformationWithHTTPInfo(
        ...
        guard !transformationID.isEmpty else {
            throw FlapjackError.invalidArgument("transformationID", "deleteTransformation")
        }
    ...
    open func disableTaskWithHTTPInfo(
        ...
        guard !taskID.isEmpty else {
            throw FlapjackError.invalidArgument("taskID", "disableTask")
        }
    ...
    open func disableTaskV1WithHTTPInfo(
        ...
        guard !taskID.isEmpty else {
            throw FlapjackError.invalidArgument("taskID", "disableTaskV1")
        }
    ...
    open func enableTaskWithHTTPInfo(
        ...
        guard !taskID.isEmpty else {
            throw FlapjackError.invalidArgument("taskID", "enableTask")
        }
    ...
    open func enableTaskV1WithHTTPInfo(
        ...
        guard !taskID.isEmpty else {
            throw FlapjackError.invalidArgument("taskID", "enableTaskV1")
        }
    ...
    open func getAuthenticationWithHTTPInfo(
        ...
        guard !authenticationID.isEmpty else {
            throw FlapjackError.invalidArgument("authenticationID", "getAuthentication")
        }
    ...
    open func getDestinationWithHTTPInfo(
        ...
        guard !destinationID.isEmpty else {
            throw FlapjackError.invalidArgument("destinationID", "getDestination")
        }
    ...
    open func getEventWithHTTPInfo(
        ...
        guard !runID.isEmpty else {
            throw FlapjackError.invalidArgument("runID", "getEvent")
        }

        guard !eventID.isEmpty else {
            throw FlapjackError.invalidArgument("eventID", "getEvent")
        }
    ...
    open func getRunWithHTTPInfo(
        ...
        guard !runID.isEmpty else {
            throw FlapjackError.invalidArgument("runID", "getRun")
        }
    ...
    open func getSourceWithHTTPInfo(
        ...
        guard !sourceID.isEmpty else {
            throw FlapjackError.invalidArgument("sourceID", "getSource")
        }
    ...
    open func getTaskWithHTTPInfo(
        ...
        guard !taskID.isEmpty else {
            throw FlapjackError.invalidArgument("taskID", "getTask")
        }
    ...
    open func getTaskV1WithHTTPInfo(
        ...
        guard !taskID.isEmpty else {
            throw FlapjackError.invalidArgument("taskID", "getTaskV1")
        }
    ...
    open func getTransformationWithHTTPInfo(
        ...
        guard !transformationID.isEmpty else {
            throw FlapjackError.invalidArgument("transformationID", "getTransformation")
        }
    ...
    open func listEventsWithHTTPInfo(
        ...
        guard !runID.isEmpty else {
            throw FlapjackError.invalidArgument("runID", "listEvents")
        }
    ...
    // see the status of your task. If you want to leverage the [pre-indexing data transformation](https://www.flapjack.io/doc/guides/sending-and-managing-data/send-and-update-your-data/how-to/transform-your-data),
    ...
    open func pushWithHTTPInfo(
        ...
        guard !indexName.isEmpty else {
            throw FlapjackError.invalidArgument("indexName", "push")
        }
    ...
    open func pushTaskWithHTTPInfo(
        ...
        guard !taskID.isEmpty else {
            throw FlapjackError.invalidArgument("taskID", "pushTask")
        }
    ...
    open func replaceTaskWithHTTPInfo(
        ...
        guard !taskID.isEmpty else {
            throw FlapjackError.invalidArgument("taskID", "replaceTask")
        }
    ...
    open func runSourceWithHTTPInfo(
        ...
        guard !sourceID.isEmpty else {
            throw FlapjackError.invalidArgument("sourceID", "runSource")
        }
    ...
    open func runTaskWithHTTPInfo(
        ...
        guard !taskID.isEmpty else {
            throw FlapjackError.invalidArgument("taskID", "runTask")
        }
    ...
    open func runTaskV1WithHTTPInfo(
        ...
        guard !taskID.isEmpty else {
            throw FlapjackError.invalidArgument("taskID", "runTaskV1")
        }
    ...
    open func triggerDockerSourceDiscoverWithHTTPInfo(
        ...
        guard !sourceID.isEmpty else {
            throw FlapjackError.invalidArgument("sourceID", "triggerDockerSourceDiscover")
        }
    ...
    open func tryTransformationBeforeUpdateWithHTTPInfo(
        ...
        guard !transformationID.isEmpty else {
            throw FlapjackError.invalidArgument("transformationID", "tryTransformationBeforeUpdate")
        }
    ...
    open func updateAuthenticationWithHTTPInfo(
        ...
        guard !authenticationID.isEmpty else {
            throw FlapjackError.invalidArgument("authenticationID", "updateAuthentication")
        }
    ...
    open func updateDestinationWithHTTPInfo(
        ...
        guard !destinationID.isEmpty else {
            throw FlapjackError.invalidArgument("destinationID", "updateDestination")
        }
    ...
    open func updateSourceWithHTTPInfo(
        ...
        guard !sourceID.isEmpty else {
            throw FlapjackError.invalidArgument("sourceID", "updateSource")
        }
    ...
    open func updateTaskWithHTTPInfo(
        ...
        guard !taskID.isEmpty else {
            throw FlapjackError.invalidArgument("taskID", "updateTask")
        }
    ...
    open func updateTaskV1WithHTTPInfo(
        ...
        guard !taskID.isEmpty else {
            throw FlapjackError.invalidArgument("taskID", "updateTaskV1")
        }
    ...
    open func updateTransformationWithHTTPInfo(
        ...
        guard !transformationID.isEmpty else {
            throw FlapjackError.invalidArgument("transformationID", "updateTransformation")
        }
    ...
    open func validateSourceBeforeUpdateWithHTTPInfo(
        ...
        guard !sourceID.isEmpty else {
            throw FlapjackError.invalidArgument("sourceID", "validateSourceBeforeUpdate")
        }
