...
public partial class Rule
{
  ...
  /// <summary>
  /// Conditions that trigger a rule.  Some consequences require specific conditions or don't require any condition. For more information, see [Conditions](https://www.flapjack.io/doc/guides/managing-results/rules/rules-overview/#conditions).
  /// </summary>
  /// <value>Conditions that trigger a rule.  Some consequences require specific conditions or don't require any condition. For more information, see [Conditions](https://www.flapjack.io/doc/guides/managing-results/rules/rules-overview/#conditions). </value>
