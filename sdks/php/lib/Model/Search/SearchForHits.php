 ...
 * @category Class
 */
class SearchForHits extends AbstractModel implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    /**
    ...
    protected static $modelTypes = [
        ...
        'indexName' => 'string',
        'type' => '\Flapjack\FlapjackSearch\Model\Search\SearchTypeDefault',
    ];
